...
(function( MATHML, BROWSER )
{
    ...
    MATHML.Parse = MathJax.Object.Subclass( {
        ...
        TeXAtom: function( mclass )
        {
            ...
            if (mml.texClass === MML.TEXCLASS.OP) {
                ...
                if (CLASS[i].substr( 0, 4 ) === "MJX-") {
                    if (CLASS[i] === "MJX-arrow") {
                        ...
                        if (CLASS[i] === "MJX-variant") {
                            ...
                            if (CLASS[i].substr( 0, 11 ) !== "MJX-TeXAtom") {
        ...
        AddAttributes: function( mml, node )
        {
            ...
            for (var i = 0, m = node.attributes.length; i < m; i++) {
                ...
                if (name.match( /^_moz-math-((column|row)(align|line)|font-style)$/ )) {
                    continue;
                }
    ...
    MATHML.Augment( {
        ...
        prefilterMath: function( math, script )
        {
            return math
        },
        prefilterMathML: function( math, script )
        {
            return math
        },
