    ...
    var CELLSPACING = function( obj, rowSpacing, columnSpacing )
    {
        ...
        if (obj) {
            ...
            if (span.style.padding === "") {
                var padding = {
                    paddingLeft: columnSpacing, paddingTop: rowSpacing,
        ...
        MML.mbase.Augment( {
            ...
            NativeMMLattribute: function( value )
            {
                ...
                if (nMML.NAMEDSPACE[value]) {
                    ...
                    if (value.match( /^\s*(([-+])?(\d+(\.\d*)?|\.\d+))\s*mu\s*$/ )) {
                        value = (RegExp.$2 || "") + ((1 / 18) * RegExp.$3).toFixed( 3 ).replace( /\.?0+$/, "" ) + "em"
                    } // FIXME:  should take scriptlevel into account
                    else {
                        if (this.NativeMMLvariants[value]) {
        ...
        MML.mrow.Augment( {
            ...
            toNativeMML: function( parent )
            {
                ...
                if (this.inferred && this.parent.inferRow) {
                    ...
                    if (nMML.stretchyMoBug && (this.open || this.close)) {
                        //
                ...
                toNativeMML: function( parent )
                {
                    ...
                    if (this.nMMLhasLabels) {
                        ...
                        if (this.nMMLforceWidth || side !== "r") {
                            ...
                            if (n) {
                                var attr = {
                                    columnalign: "left", columnwidth: "auto",
        ...
        MML.mfenced.Augment( {
            toNativeMML: function( parent )
            {
                ...
                if (values.separators.length == 0) {
                    ...
                    if (values.separators.length < this.data.length - 1) {
                        //
