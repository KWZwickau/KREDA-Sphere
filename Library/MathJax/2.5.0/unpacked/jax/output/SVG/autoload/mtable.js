...
//          if (row.data[j-s].isMultiline) {A[i][j].style.width = "100%"}
                    if (cell.isEmbellished()) {
                        ...
                        if (min) {
                            if (mo.SVGcanStretch( "Vertical" )) {
                                ...
                                if (mo.SVGcanStretch( "Horizontal" )) {
            ...
            for (i = 0, m = CSPACE.length; i < m; i++) {
                CSPACE[i] = SVG.length2em( CSPACE[i], mu )
            }
            for (i = 0, m = RSPACE.length; i < m; i++) {
                RSPACE[i] = SVG.length2em( RSPACE[i], mu )
            }
            ...
            if (values.equalcolumns && values.width !== "auto") {
                    ...
                    if (CWIDTH[i] === "auto") {
                        ...
                        if (CWIDTH[i] === "fit") {
                            ...
                            if (CWIDTH[i].match( /%$/ )) {
                                ...
                                p++;
                                Wp += W[i];
                                WP += SVG.length2em( CWIDTH[i], mu, 1 )
                            }
                            else {
                                W[i] = SVG.length2em( CWIDTH[i], mu );
                                Wt += W[i]
                            }
                        }
                    }
                ...
                for (i = 0, m = P.length; i < m; i++) {
                    W[P[i]] = SVG.length2em( CWIDTH[P[i]], mu, WW * Wf );
                    Wt += W[P[i]];
                }
                ...
                for (i = 0, m = A.length; i < m; i++) {
                    if (A[i][j]) {
                        ...
                        if (cell.SVGcanStretch( "Horizontal" )) {
                            ...
                            if (cell.SVGcanStretch( "Vertical" )) {
                                mo = cell.CoreMO();
