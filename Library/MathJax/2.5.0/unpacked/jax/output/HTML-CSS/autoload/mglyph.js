        ...
        toHTML: function( span, variant )
        {
            ...
            if (values.src === "") {
                ...
                if (this.img.status !== "OK") {
                    ...
                    if (values.width) {
                        img.style.width = HTMLCSS.Em( HTMLCSS.length2em( values.width, mu,
                            this.img.img.width / HTMLCSS.em ) );
                    }
                    if (values.height) {
                        img.style.height = HTMLCSS.Em( HTMLCSS.length2em( values.height, mu,
                            this.img.img.height / HTMLCSS.em ) );
                    }
