...
MathJax.Hub.Register.StartupHook( "HTML-CSS Jax Ready", function()
{
    ...
    MML.menclose.Augment( {
        toHTML: function( span )
        {
            ...
            if (values.thickness == null) {
                values.thickness = ".075em"
            }
            if (values.padding == null) {
                values.padding = ".2em"
            }
            ...
            stack.insertBefore( frame, base ); // move base to above background
            var T = 0, B = 0, R = 0, L = 0, dx = 0, dy = 0;
            var svg, vml;
            var w, h, r;
            if (!values.mathcolor) {
                values.mathcolor = "black"
            } else {
            ...
            if (notation[MML.NOTATION.UPDIAGONALARROW]) {
                notation[MML.NOTATION.UPDIAGONALSTRIKE] = false;
            }

            var line;
            for (var n in notation) {
                if (!notation.hasOwnProperty( n ) || !notation[n]) {
                    continue;
                }
                switch (n) {
                    ...
                    case MML.NOTATION.ROUNDEDBOX:
                        if (HTMLCSS.useVML) {
                            if (!vml) {
                                vml = this.HTMLvml( stack, H, D, W, t, values.mathcolor )
                            }
                    ...
                    case MML.NOTATION.VERTICALSTRIKE:
                        ...
                        HTMLCSS.placeBox( line, p + t + base.bbox.w / 2, -D, true );
                        break;
                    ...
                    case MML.NOTATION.HORIZONTALSTRIKE:
                        ...
                        HTMLCSS.addBox( stack, line );
                        HTMLCSS.placeBox( line, 0, (H + D) / 2 - D, true );
                        break;
                    ...
                    case MML.NOTATION.UPDIAGONALSTRIKE:
                        if (HTMLCSS.useVML) {
                            ...
                            line = this.HTMLvmlElement( vml, "line",
                                {from: "0," + this.HTMLpx( H + D - t ), to: this.HTMLpx( W ) + ",0"} );
                        } else {
                            if (!svg) {
                                svg = this.HTMLsvg( stack, H, D, W, t, values.mathcolor )
                            }
                    ...
                    case MML.NOTATION.UPDIAGONALARROW:
                        if (HTMLCSS.useVML) {
                            ...
                            line = this.HTMLvmlElement( vml, "line", {
                                from: "0," + this.HTMLpx( H + D - t ),
                                to: this.HTMLpx( W ) + "," + this.HTMLpx( t )
                            } );
                            ...
                            this.HTMLsvgElement( svg.firstChild, "line", {
                                x1: 1,
                                y1: this.HTMLpx( H + D - t ),
                                x2: this.HTMLpx( x - .7 * w ),
                                y2: this.HTMLpx( y + .7 * h )
                            } );
                    ...
                    case MML.NOTATION.DOWNDIAGONALSTRIKE:
                        if (HTMLCSS.useVML) {
                            ...
                            this.HTMLvmlElement( vml, "line",
                                {from: "0,0", to: this.HTMLpx( W ) + "," + this.HTMLpx( H + D - t )} );
                        } else {
                            if (!svg) {
                                svg = this.HTMLsvg( stack, H, D, W, t, values.mathcolor )
                            }
                    ...
                    case MML.NOTATION.PHASORANGLE:
                        ...
                        if (HTMLCSS.useVML) {
                            ...
                            this.HTMLvmlElement( vml, "shape", {
                                ...
                                " l " + this.HTMLpt( t / 2, H + D - t ) + " " + this.HTMLpt( W - t / 2,
                                    H + D - t ) + " e",
                    ...
                    case MML.NOTATION.RADICAL:
                        if (HTMLCSS.useVML) {
                            ...
                            this.HTMLvmlElement( vml, "shape", {
                                style: {width: this.HTMLpx( W ), height: this.HTMLpx( H + D )},
                                path: "m " + this.HTMLpt( t / 2, .6 * (H + D) ) + " l " + this.HTMLpt( p,
                                    H + D - t ) + " " +
                    ...
                    case MML.NOTATION.LONGDIV:
                        if (HTMLCSS.useVML) {
                            ...
                            this.HTMLvmlElement( vml, "line", {
                                from: "0," + this.HTMLpx( t / 2 ),
                                to: this.HTMLpx( W - t ) + "," + this.HTMLpx( t / 2 )
                            } );
        ...
        HTMLpt: function( x, y )
        {
            return Math.floor( 1000 * x ) + ',' + Math.floor( 1000 * y )
        },
        ...
        HTMLhandleColor: function( span )
        {
            ...
            if (frame) {
                ...
                this.SUPER( arguments ).HTMLhandleColor.call( this, span )
            }
        },
        ...
        HTMLsvg: function( stack, H, D, W, t, color )
        {
            ...
            if (svg.style) {
                svg.style.width = HTMLCSS.Em( W );
                svg.style.height = HTMLCSS.Em( H + D )
            }
        ...
        HTMLvml: function( stack, H, D, W, t, color )
        {
            ...
            HTMLCSS.addBox( stack, vml );
            HTMLCSS.placeBox( vml, 0, -D, true );
            this.constructor.VMLcolor = color;
            this.constructor.VMLthickness = this.HTMLpx( t );
            return vml;
        },
        HTMLvmlElement: function( vml, type, def )
        {
            ...
            if (!def.strokeweight) {
                obj.strokeweight = this.constructor.VMLthickness
            }
            return obj;
        }
    } );
