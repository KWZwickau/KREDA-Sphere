...
(function( HTMLCSS )
{
    ...
    var delim = {
        ...
        {
            dir: H,
            HW: [[.926, GENERAL], [1.063, SIZE1], [1.606, SIZE2], [2.147, SIZE3], [2.692, SIZE4], [3.237, SIZE5]],
        ...
        0x23B5: // bottom square bracket
        {
            ...
            HW: [[.926, GENERAL], [1.063, SIZE1], [1.606, SIZE2], [2.147, SIZE3], [2.692, SIZE4], [3.237, SIZE5]],
            stretch: {
                left: [0x2A3D, GENERAL, 0, .12],
                rep: [0x2212, GENERAL, 0, 0, 0, .12],
                right: [0x2A3C, GENERAL, 0, .12]
            }
        },
        0x23DC: // top paren
        {
        ...
        0x23E0: // top tortoise shell
        {
            ...
            stretch: {
                left: [0xE10D, NONUNI, -.1, -.1],
                rep: [0x2212, GENERAL, 0, .05],
                right: [0xE10C, NONUNI, 0, -.1],
                fullExtenders: true
            }
        },
        0x23E1: // bottom tortoise shell
        {
            dir: H, HW: [[1, GENERAL], [1.460, SIZE1], [1.886, SIZE2], [2.312, SIZE3], [2.738, SIZE4], [3.164, SIZE5]],
            stretch: {
                left: [0xE10C, NONUNI, -.1, .1],
                rep: [0x2212, GENERAL, 0, -.1, 0, .1],
                right: [0xE10D, NONUNI, 0, .1],
                fullExtenders: true
            }
        },
