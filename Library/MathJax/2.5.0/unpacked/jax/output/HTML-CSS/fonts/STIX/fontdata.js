        ...
        FONTDATA: {
            ...
            VARIANT: {
                "normal": {
                    ...
                    remap: {0x2205: [0x2205, "-STIX-variant"]}
                }, // \emptyset
                ...
                "double-struck": {
                    offsetA: 0x1D538, offsetN: 0x1D7D8,
                    remap: {
                ...
                "script": {
                    fonts: [ITALIC], offsetA: 0x1D49C, italic: true,
                    remap: {
                ...
                "monospace": {
                    offsetA: 0x1D670, offsetN: 0x1D7F6,
                    remap: {0x20: [0x20, "-STIX-variant"]}
                ...
                "-tex-oldstyle": {
                    offsetN: 0xE261,
                    remap: {
                        0xE262: 0xE265, 0xE263: 0xE269, 0xE264: 0xE26D, 0xE265: 0xE271,
                ...
                "-tex-oldstyle-bold": {
                    ...
                    offsetN: 0xE263,
                    remap: {
                        0xE264: 0xE267, 0xE265: 0xE26B, 0xE266: 0xE26F,
            ...
            DELIMITERS: {
                ...
                {
                    dir: V, HW: [
                    [.690, GENERAL], [1.230, SIZE1], [1.353, SIZE1, 1.1], [1.845, SIZE2],
                    [2.048, SIZE2, 1.11], [2.460, SIZE3], [2.472, SIZE3, 1.005], [3.075, SIZE4]
                ]
                },
                0x005B: // [
                {
                    dir: V, HW: [
                    [.818, GENERAL], [1.230, SIZE1], [1.353, SIZE1, 1.1], [1.845, SIZE2],
                    [2.048, SIZE2, 1.11], [2.460, SIZE3], [2.472, SIZE3, 1.005], [3.075, SIZE4]
                ],
                ...
                {
                    dir: V, HW: [
                    [.861, GENERAL], [1.230, SIZE1], [1.353, SIZE1, 1.1], [1.845, SIZE2],
                    [2.048, SIZE2, 1.11], [2.460, SIZE3], [2.472, SIZE3, 1.005], [3.075, SIZE4]
                ],
                ...
                {
                    dir: H,
                    HW: [[.333, GENERAL], [.560, SIZE1], [.979, SIZE2], [1.46, SIZE3], [1.886, SIZE4], [2.328, SIZE5]]
                },
                0x02C7: // wide caron
                {
                    dir: H,
                ...
                {
                    dir: H,
                    HW: [[.333, GENERAL], [.558, SIZE1], [.978, SIZE2], [1.458, SIZE3], [1.886, SIZE4], [2.328, SIZE5]]
                },
                ...
                {
                    dir: V,
                    HW: [[.954, "STIXVariants"], [1.232, GENERAL], [1.847, SIZE1], [2.460, SIZE2], [3.075, SIZE3]],
                ...
                {
                    dir: V, HW: [
                    [.926, GENERAL], [1.230, SIZE1], [1.353, SIZE1, 1.1], [1.845, SIZE2],
                    [2.048, SIZE2, 1.11], [2.460, SIZE3], [2.472, SIZE3, 1.005], [3.075, SIZE4]
                ],
                ...
                {
                    dir: H,
                    HW: [[.926, SIZE1], [1, GENERAL], [1.46, SIZE2], [1.886, SIZE3], [2.328, SIZE4], [3.238, SIZE5]],
                    stretch: {
                        left: [0xE13B, NONUNI],
                        mid: [0xE140, NONUNI],
                        right: [0xE13C, NONUNI],
    ...
    MathJax.Hub.Browser.Select( {
        MSIE: function( browser )
        {
            if (!browser.versionAtLeast( "8.0" ) || document.documentMode < 8) {
                ...
                FONTDATA.RANGES[3] = {
                    name: "greek", low: 0x03B1, high: 0x03F6, offset: "GG",
