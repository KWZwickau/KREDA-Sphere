...
(function( HUB, HTML, AJAX, CALLBACK, LOCALE, OUTPUT, INPUT )
{
    ...
    var EVENT = ME.Event = {
        ...
        ContextMenu: function( event, math, force )
        {
            ...
            if (!show || (SETTINGS.context !== "MathJax" && !force)) {
                return;
            }
        ...
        AltContextMenu: function( event, math )
        {
            ...
            if (show) {
                ...
                if (SETTINGS.context === "MathJax" && !SETTINGS.mpContext && show) {
                    if (!ME.noContextMenuBug || event.button !== EVENT.RIGHTBUTTON) {
                        return;
                    }
                } else {
                    if (!event[EVENT.MENUKEY] || event.button !== EVENT.LEFTBUTTON) {
                        return;
                    }
                }
    ...
    var HOVER = ME.Hover = {
        ...
        Mousemove: function( event, math )
        {
            if (SETTINGS.discoverable || SETTINGS.zoom === "Hover") {
                ...
                if (HOVER.lastX == event.clientX && HOVER.lastY == event.clientY) {
                    return;
                }
        ...
        Hover: function( jax, math )
        {
            ...
            //
            if (EXTENSION.MathZoom && EXTENSION.MathZoom.Hover( {}, math )) {
                return;
            }
            //
            //  Get the hover data
