...
//
                    ...
                    do {
                        ...
                        if (e) {
                            ...
                            if ($char( '(' )) {
                                ...
                                if ($char( ')' )) {
                                    if (p && e) {
                                        nodes.push( new (tree.Paren)( new (tree.Rule)( p, e, null, null, i,
                                            env.currentFileInfo, true ) ) );
                                    } else {
                                        if (e) {
    ...
    (function( tree )
    {
        ...
        tree.functions = {
            ...
            escape: function( str )
            {
                return new (tree.Anonymous)( encodeURI( str.value ).replace( /=/g, "%3D" ).replace( /:/g,
                    "%3A" ).replace( /#/g, "%23" ).replace( /;/g, "%3B" ).replace( /\(/g, "%28" ).replace( /\)/g,
                    "%29" ) );
            },
            ...
            pow: function( x, y )
            {
                if (typeof x === "number" && typeof y === "number") {
                    ...
                    if (!(x instanceof tree.Dimension) || !(y instanceof tree.Dimension)) {
            ...
            _minmax: function( isMin, args )
            {
                ...
                for (i = 0; i < args.length; i++) {
                    ...
                    currentUnified = current.unit.toString() === "" && unitClone !== undefined ? new (tree.Dimension)( current.value,
                        unitClone ).unify() : current.unify();
                    ...
                    referenceUnified = order[j].unit.toString() === "" && unitClone !== undefined ? new (tree.Dimension)( order[j].value,
                        unitClone ).unify() : order[j].unify();
...
//
    ...
    (function( tree )
    {
        ...
        tree.DetachedRuleset.prototype = {
            ...
            {
                return this.ruleset.eval( this.frames ? new (tree.evalEnv)( env,
                    this.frames.concat( env.frames ) ) : env );
            }
        };
    })( require( '../tree' ) );
            ...
            operate: function( env, op, other )
            {
                ...
                if (op === '+' || op === '-') {
                    if (unit.numerator.length === 0 && unit.denominator.length === 0) {
                        ...
                        if (other.unit.numerator.length === 0 && unit.denominator.length === 0) {
                            // do nothing
                        } else {
...
// http://www.w3.org/TR/css3-values/#absolute-lengths
    ...
    (function( tree )
    {
        ...
        tree.Directive.prototype = {
            ...
            {
                if (this.rules) {
                    return tree.Ruleset.prototype.variable.call( this.rules, name );
                }
            },
            find: function()
            {
                if (this.rules) {
                    return tree.Ruleset.prototype.find.apply( this.rules, arguments );
                }
            },
            rulesets: function()
            {
                if (this.rules) {
                    return tree.Ruleset.prototype.rulesets.apply( this.rules );
                }
            },
            markReferenced: function()
            {
...
//
        tree.Import.prototype = {
            ...
            getPath: function()
            {
                if (this.path instanceof tree.Quoted) {
                    ...
                    if (this.path instanceof tree.URL) {
            ...
            {
                return new (tree.Import)( this.path.eval( env ), this.features, this.options, this.index,
                    this.currentFileInfo );
            },
    ...
    (function( tree )
    {
        ...
        tree.mixin.Definition = function( name, params, rules, condition, variadic, frames )
        {
            ...
            this.selectors = [
                new (tree.Selector)( [
                    new (tree.Element)( null, name, this.index, this.currentFileInfo )
                ] )
            ];
            this.params = params;
        ...
        tree.mixin.Definition.prototype = {
            ...
            eval: function( env )
            {
                return new tree.mixin.Definition( this.name, this.params, this.rules, this.condition, this.variadic,
                    this.frames || env.frames.slice( 0 ) );
            },
            ...
            eval: function( env )
            {
                ...
                for (i = 0; i < rsRuleCnt; i++) {
                    if (rsRules[i] instanceof tree.mixin.Call) {
                        ...
                        if (rsRules[i] instanceof tree.RulesetCall) {
                            /*jshint loopfunc:true */
                        ...
                        for (j = 0; j < newSelectors.length; j++) {
                            ...
                            if (context.length === 0) {
                                ...
                                if (sel.length > 0) {
                                    ...
                                    sel[0].elements.push( new (tree.Element)( el.combinator, '', el.index,
                                        el.currentFileInfo ) );
                                }
                                ...
                                for (k = 0; k < context.length; k++) {
                                    ...
                                    if (parentSel.length > 0) {
                                        ...
                                        newJoinedSelector.elements.push( new (tree.Element)( el.combinator,
            ...
            visitImport: function( importNode, visitArgs )
            {
                ...
                if (!importNode.css || inlineCSS) {
                    ...
                    if (evaldImportNode && (!evaldImportNode.css || inlineCSS)) {
                        ...
                        this._importer.push( importNode.getPath(), importNode.currentFileInfo, importNode.options,
                            function( e, root, importedAtRoot, fullPath )
                            {
                                if (e && !e.filename) {
                                    e.index = importNode.index;
                                    e.filename = importNode.currentFileInfo.filename;
                                ...
                                if (root) {
                                    ...
                                    if (!inlineCSS && (env.importMultiple || !duplicateImport)) {
                                        ...
                                        new (tree.importVisitor)( importVisitor._importer, subFinish, env,
                                            importVisitor.onceFileDetectionMap, importVisitor.recursionDetector )
                                            .run( root );
                                        return;
                                    }
                                }
        ...
        tree.processExtendsVisitor.prototype = {
            ...
            doExtendChaining: function( extendsList, extendsListTarget, iterationCount )
            {
                    ...
                    for (targetExtendIndex = 0; targetExtendIndex < extendsListTarget.length; targetExtendIndex++) {
                        ...
                        if (matches.length) {
                            ...
                            extend.selfSelectors.forEach( function( selfSelector )
                            {
                                ...
                                newExtend.parent_ids = newExtend.parent_ids.concat( targetExtend.parent_ids,
                                    extend.parent_ids );
                ...
                if (extendsToAdd.length) {
                    ...
                    return extendsToAdd.concat( extendVisitor.doExtendChaining( extendsToAdd, extendsListTarget,
                        iterationCount + 1 ) );
                } else {
                    return extendsToAdd;
                }
                ...
                for (extendIndex = 0; extendIndex < allExtends.length; extendIndex++) {
                    for (pathIndex = 0; pathIndex < rulesetNode.paths.length; pathIndex++) {
                        ...
                        if (matches.length) {
                            ...
                            {
                                selectorsToAdd.push( extendVisitor.extendSelector( matches, selectorPath,
                                    selfSelector ) );
                            } );
                        }
                    }
            ...
            visitDirective: function( directiveNode, visitArgs )
            {
                ...
                newAllExtends = newAllExtends.concat( this.doExtendChaining( newAllExtends,
                    directiveNode.allExtends ) );
                this.allExtendsStack.push( newAllExtends );
            },
            visitDirectiveOut: function( directiveNode )
...
//Setup user functions
    ...
    function error( e, rootHref )
    {
        if (!less.errorReporting || less.errorReporting === "html") {
            ...
            if (less.errorReporting === "console") {
                errorConsole( e, rootHref );
            } else {
                if (typeof less.errorReporting === 'function') {
        ...
        for (var i = 0; i < styles.length; i++) {
            ...
            if (style.type.match( typePattern )) {
                ...
                new (less.Parser)( env ).parse( lessText, callback,
                    {globalVars: less.globalVars, modifyVars: modifyVars} );
            }
        }
    }
    ...
    function loadFile( originalHref, currentFileInfo, callback, env, modifyVars )
    {
        ...
        if (newFileInfo.relativeUrls) {
            if (env.rootpath) {
                newFileInfo.rootpath = extractUrlParts( env.rootpath + pathDiff( hrefParts.path,
