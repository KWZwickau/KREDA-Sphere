...
<form>
    ...
    <table border=1>
        ...
        <tr>
            ...
            <td><input type=text name=url size=50 value="<?php print $url; ?>" <?php if ($ask_url == 0) {
                    print " readonly";
                } ?>></td>
        </tr>
        ...
        <tr>
            <td><b>Use HTTPS:</b></td>
            <td><input type=checkbox name=https value=1 <?php if ($https) {
                    print "checked";
                } ?>></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type=checkbox name=httpsverify value=1 <?php if ($httpsverify) {
                    print "checked";
                } ?>></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type=checkbox name=wait_for_all value=1 <?php if ($wait_for_all) {
                    print "checked";
                } ?>></td>
        </tr>
