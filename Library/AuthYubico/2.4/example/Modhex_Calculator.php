    ...
    <div id="bottomContent">
        ...
        <form action=Modhex_Calculator.php method=post autocomplete=off>
            <fieldset>
                ...
                <input type="radio" name="srcfmt" value="P" <?php echo ( $srcfmt_org == "P" ) ? 'checked' : ''; ?>>Plain
                text<br/>
                ...
                <input type="radio" name="srcfmt"
                       value="H" <?php echo ( $srcfmt_org == "H" ) ? 'checked' : ''; ?>>Hex<br/>
                <input type="radio" name="srcfmt"
                       value="O" <?php echo ( $srcfmt_org == "O" ) ? 'checked' : ''; ?>>OTP<br/>
