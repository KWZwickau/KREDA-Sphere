...
<div id="container">
    ...
    <div id="bottomContent">
        ...
        if ($authenticated == 0) {
            ?>
            <h1 class="ok">Congratulations <?php if ($realname) {
                    print "$realname!";
                } ?></h1>
        ...
        <?php } else { ?>
            ...
            <form name="login" method="post"
                  style="border: 1px solid #e5e5e5; background-color: #f1f1f1; padding: 10px; margin: 0px;"
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td width="470">
                            <input autocomplete="off" type="text" name="key" class="yubiKeyInput"><input type="submit"
                                                                                                         value="Go"
                                                                                                         style="border: 0px; font-size: 0px; background: none; padding: 0px; margin: 0px; width: 0px; height: 0px;"/>
                        </td>
                    </tr>
                </table>
            </form>
        ...
        <p>&raquo; <a href="two_factor.php">Try again</a></p>
