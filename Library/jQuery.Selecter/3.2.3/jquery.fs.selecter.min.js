...
!function( a, b )
{
    ...
    function i( c )
    {
        ...
        if (!d.$select.is( ":disabled" )) {
            if (a( ".selecter" ).not( d.$selecter ).trigger( "close.selecter",
                    [d] ), d.mobile || !A || B) {
    ...
    function q( b )
    {
        ...
        if (13 === b.keyCode) {
            ...
            if (!(9 === b.keyCode || b.metaKey || b.altKey || b.ctrlKey || b.shiftKey)) {
                ...
                if (a.inArray( b.keyCode, z ? [38, 40, 37, 39] : [
                        38,
                        40
                    ] ) > -1) {
    ...
    a.fn.selecter = function( a )
    {
        return E[a] ? E[a].apply( this,
            Array.prototype.slice.call( arguments, 1 ) ) : "object" != typeof a && a ? this : c.apply( this, arguments )
