...
(function( F, n, K )
{
    var A = function( d )
    {
        KeyTable = function( j )
        {
            ...
            function L( a )
            {
                return function( e, c, p )
                {
                    (null === e || "number" == typeof e) && (null === c || "number" == typeof c) ? "function" == typeof p ? B( a,
                        e, c, p ) : B( a, e, c ) : "object" == typeof e ? (e = E( e ), "function" == typeof c ? B( a,
                        e[0], e[1], c ) : B( a, e[0],
                        e[1] )) : alert( "Unhandable event type was removed: x" + e + "  y:" + c + "  z:" + p )
                }
            }
            ...
            function B( a, e, c, p )
            {
                for (var h = 0, b = 0, d = k[a].length; b < d - h; b++) {
                    if ("undefined" != typeof p) {
                        k[a][b - h].x == e && (k[a][b - h].y == c && k[a][b - h].fn == p) && (k[a].splice( b - h,
                            1 ), h++);
                    } else {
                        if (k[a][b - h].x == e && k[a][b - h].y == c) {
            ...
            function C( a, e, c )
            {
                for (var p = 0, a = k[a], b = 0; b < a.length; b++) {
                    if (a[b].x == e && a[b].y == c || null === a[b].x && a[b].y == c || a[b].x == e && null === a[b].y ||
                        null === a[b].x && null === a[b].y) {
                        a[b].fn( w( e, c ), e, c ), p++;
                    }
                }
                return p
                ...
                if (t != a) {
                    ...
                    if (i) {
                        ...
                        for (; b < c._iDisplayStart;) {
                            c._iDisplayStart = 0 <= c._iDisplayLength ? c._iDisplayStart - c._iDisplayLength : 0, 0 > c._iDisplayStart &&
                            (c._iDisplayStart = 0), i.oApi._fnCalculateEnd( c );
                        }
                        i.oApi._fnDraw( c );
                        o = h
                    }
                    ...
                    if (i && "undefined" != typeof c.oScroll && ("" !== c.oScroll.sX || "" !== c.oScroll.sY)) {
                        (c = c.nTable.parentNode, r = c.clientHeight, b = c.clientWidth, j = c.scrollTop, h = c.scrollLeft, k = a.offsetHeight, m = a.offsetWidth, a.offsetTop + k > r + j ? c.scrollTop =
                            a.offsetTop + k - r : a.offsetTop < j && (c.scrollTop = a.offsetTop), a.offsetLeft + m > b + h) ? c.scrollLeft = a.offsetLeft + m - b : a.offsetLeft < h && (c.scrollLeft = a.offsetLeft);
                    }
                    o || (o = !0);
                    C( "focus", l, g )
                }
            ...
            function E( a )
            {
                ...
                ] : [d( "td", a.parentNode ).index( a ), d( "tr", a.parentNode.parentNode ).index( a.parentNode )]
            }
            ...
            D ? (j = n.createElement( "div" ), s = n.createElement( "input" ), j.style.height = "1px", j.style.width = "0px", j.style.overflow = "hidden", "undefined" != typeof b.tabIndex &&
            (s.tabIndex = b.tabIndex), j.appendChild( s ), b.table.parentNode.insertBefore( j,
                b.table.nextSibling ), d( s ).focus( function()
            {
                if (!u) {
                    o = true;
                    u = false;
                    typeof b.focus.nodeName != "undefined" ? q( b.focus, b.initScroll ) : q( w( b.focus[0],
                        b.focus[1] ), b.initScroll );
                    setTimeout( function()
                    {
                        s.blur()
                    }, 0 )
                }
            } ), o = !1) : ("undefined" != typeof b.focus.nodeName ? q( b.focus, b.initScroll ) : q( w( b.focus[0],
                b.focus[1] ), b.initScroll ), o || (o = !0));
    ...
    "function" === typeof define && define.amd ? define( ["jquery", "datatables"],
        A ) : "object" === typeof exports ? A( require( "jquery" ),
        require( "datatables" ) ) : jQuery && !jQuery.fn.dataTable.KeyTable && A( jQuery, jQuery.fn.dataTable )
})( window, document );
