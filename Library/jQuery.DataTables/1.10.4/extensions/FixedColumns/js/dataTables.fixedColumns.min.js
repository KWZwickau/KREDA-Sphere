    ...
    var o = function( d )
    {
        var k = function( a, b )
        {
            ...
            if (!this instanceof k) {
                ...
                d.fn.dataTable.camelToHungarian && d.fn.dataTable.camelToHungarian( k.defaults, b );
                var g = d.fn.dataTable.Api ? (new d.fn.dataTable.Api( a )).settings()[0] : a.fnSettings();
        ...
        k.prototype = {
            ...
            }, fnGetPosition: function( a )
            {
                ...
                if (d( a ).parents( ".DTFC_Cloned" ).length) {
                    if ("tr" === a.nodeName.toLowerCase()) {
                        return a = d( a ).index(), b.fnGetPosition( d( "tr",
                            this.s.dt.nTBody )[a] );
                    }
            ...
            }, _fnConstruct: function( a )
            {
                ...
                if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck( "1.8.0" )) {
                    alert( "FixedColumns " + k.VERSION + " required DataTables 1.8.0 or later. Please upgrade your DataTables installation" );
                } else {
                    if ("" === this.s.dt.oScroll.sX) {
                        this.s.dt.oInstance.oApi._fnLog( this.s.dt, 1,
                        ...
                        var g =
                            "onwheel"in r.createElement( "div" ) ? "wheel.DTFC" : "mousewheel.DTFC";
                        if (0 < b.s.iLeftColumns) {
                            d( b.dom.grid.left.liner ).on( "mouseover.DTFC touchstart.DTFC",
                                function()
                                {
                                    c = "left"
                                } ).on( "scroll.DTFC", function()
                        ...
                        if (0 < b.s.iRightColumns) {
                            d( b.dom.grid.right.liner ).on( "mouseover.DTFC touchstart.DTFC",
                                function()
                                {
                                    c = "right"
                                } ).on( "scroll.DTFC", function()
            ...
            }, _fnColCalc: function()
            {
                ...
                d.each( this.s.dt.aoColumns, function( g, f )
                {
                    ...
                    if (e.filter( ":visible" ).length) {
                        var i = e.outerWidth();
                        0 === a.s.aiOuterWidths.length && (h = d( a.s.dt.nTable ).css( "border-left-width" ), i += "string" === typeof h ? 1 : parseInt( h,
                            10 ));
                        ...
                        a.s.iTableColumns - a.s.iRightColumns <= g && (c += i)
                    } else {
            ...
            }, _fnGridSetup: function()
            {
                ...
                0 < this.s.iLeftColumns && (this.dom.grid.left.wrapper = g, this.dom.grid.left.head = g.childNodes[0], this.dom.grid.left.body = g.childNodes[1], this.dom.grid.left.liner = d( "div.DTFC_LeftBodyLiner",
                    c )[0], c.appendChild( g ));
                0 < this.s.iRightColumns && (this.dom.grid.right.wrapper = f, this.dom.grid.right.head = f.childNodes[0], this.dom.grid.right.body = f.childNodes[1], this.dom.grid.right.liner =
                    ...
                    c )[0], b.style.width = a.bar + "px", b.style.right = -a.bar + "px", this.dom.grid.right.headBlock = b, b = d( "div.DTFC_RightFootBlocker",
                    c )[0], b.style.width = a.bar + "px", b.style.right = -a.bar + "px", this.dom.grid.right.footBlock = b, c.appendChild( f ));
                if (this.s.dt.nTFoot && (this.dom.footer = this.s.dt.nTFoot.parentNode, 0 < this.s.iLeftColumns && (this.dom.grid.left.foot = g.childNodes[2]), 0 < this.s.iRightColumns)) {
                    this.dom.grid.right.foot = f.childNodes[2]
                }
            }, _fnGridLayout: function()
            {
                var a =
                    this.dom.grid, b = d( a.wrapper ).width(), c = d( this.s.dt.nTable.parentNode ).outerHeight(), g = d( this.s.dt.nTable.parentNode.parentNode ).outerHeight(), f = this._fnDTOverflow(), e = this.s.iLeftWidth, h = this.s.iRightWidth;
                f.x && (c -= f.bar);
                a.wrapper.style.height = g + "px";
                0 < this.s.iLeftColumns && (a.left.wrapper.style.width = e + "px", a.left.wrapper.style.height = "1px", a.left.body.style.height = c + "px", a.left.foot && (a.left.foot.style.top = (f.x ? f.bar : 0) + "px"), a.left.liner.style.width = e + f.bar + "px", a.left.liner.style.height = c + "px");
            ...
            }, _fnDraw: function( a )
            {
                ...
                null !== this.s.fnDrawCallback && this.s.fnDrawCallback.call( this, this.dom.clone.left,
            ...
            }, _fnCloneRight: function( a )
            {
                if (!(0 >= this.s.iRightColumns)) {
                    ...
                    for (b = this.s.iTableColumns - this.s.iRightColumns; b < this.s.iTableColumns; b++) {
                        this.s.dt.aoColumns[b].bVisible &&
                        c.push( b );
                    }
            ...
            }, _fnCopyLayout: function( a, b )
            {
                for (var c = [], g = [], f = [], e = 0, h = a.length; e < h; e++) {
                    ...
                    for (var j = 0, n = this.s.iTableColumns; j < n; j++) {
                        if (-1 !== d.inArray( j, b )) {
                            var l = d.inArray( a[e][j].cell, f );
                            -1 === l ? (l =
                                d( a[e][j].cell ).clone( !0, !0 )[0], g.push( l ), f.push( a[e][j].cell ), i.push( {
                                cell: l,
                                unique: a[e][j].unique
                            } )) : i.push( {cell: g[l], unique: a[e][j].unique} )
                        }
                    }
                    c.push( i )
                }
            ...
            }, _fnClone: function( a, b, c, g )
            {
                ...
                if (g) {
                    ...
                    m = this._fnCopyLayout( this.s.dt.aoHeader, c );
                    j = d( ">thead", a.header );
                    j.empty();
                    e = 0;
                    for (h = m.length; e < h; e++) {
                        j[0].appendChild( m[e].nTr );
                    }
                    this.s.dt.oApi._fnDrawHead( this.s.dt, m, !0 )
                } else {
                    m = this._fnCopyLayout( this.s.dt.aoHeader, c );
                    p = [];
                    this.s.dt.oApi._fnDetectHeader( p, d( ">thead", a.header )[0] );
                    e = 0;
                    for (h = m.length; e < h; e++) {
                        i = 0;
                        for (j = m[e].length; i < j; i++) {
                            p[e][i].cell.className = m[e][i].cell.className, d( "span.DataTables_sort_icon",
                                p[e][i].cell ).each( function()
                                {
                                    this.className = d( "span.DataTables_sort_icon", m[e][i].cell )[0].className
                                } )
                        }
                    }
                }
                ...
                if (0 < this.s.dt.aiDisplay.length) {
                    ...
                    for (k = 0; k < c.length; k++) {
                        n = c[k], l = d( this.s.dt.aoColumns[n].nTh ).clone( !0 )[0], l.innerHTML = "", j = l.style, j.paddingTop = "0", j.paddingBottom = "0", j.borderTopWidth = "0", j.borderBottomWidth = "0", j.height = 0, j.width = f.s.aiInnerWidths[n] + "px", h.appendChild( l );
                    }
                    d( ">tbody>tr", f.dom.body ).each( function( a )
                    {
                        var b = this.cloneNode( false );
                        b.removeAttribute( "id" );
                        a = f.s.dt.oFeatures.bServerSide === false ? f.s.dt.aiDisplay[f.s.dt._iDisplayStart + a] : a;
                        for (k = 0; k < c.length; k++) {
                            var e = f.s.dt.aoData[a].anCells ||
                                f.s.dt.oApi._fnGetTdNodes( f.s.dt, a );
                            n = c[k];
                            if (e.length > 0) {
                                l = d( e[n] ).clone( true, true )[0];
                                b.appendChild( l )
                            }
                        }
                        o.appendChild( b )
                    ...
                    {
                        l = this.cloneNode( true );
                        l.className = l.className + " DTFC_NoData";
                        d( "td", l ).html( "" );
                        o.appendChild( l )
                    } );
                }
                ...
                g && "undefined" != typeof this.s.dt.oScroller && b.liner.appendChild( this.s.dt.oScroller.dom.force.cloneNode( !0 ) );
                ...
                if (null !== this.s.dt.nTFoot) {
                    if (g) {
                        ...
                        m = this._fnCopyLayout( this.s.dt.aoFooter, c );
                        b = d( ">tfoot", a.footer );
                        b.empty();
                        e = 0;
                        for (h = m.length; e < h; e++) {
                            b[0].appendChild( m[e].nTr );
                        }
                        this.s.dt.oApi._fnDrawHead( this.s.dt, m, !0 )
                    } else {
                        m = this._fnCopyLayout( this.s.dt.aoFooter, c );
                        b = [];
                        this.s.dt.oApi._fnDetectHeader( b,
                            d( ">tfoot", a.footer )[0] );
                        e = 0;
                        for (h = m.length; e < h; e++) {
                            i = 0;
                            for (j = m[e].length; i < j; i++) {
                                b[e][i].cell.className = m[e][i].cell.className
                            }
                        }
                    }
                    this._fnEqualiseHeights( "tfoot", this.dom.footer, a.footer )
                }
                b = this.s.dt.oApi._fnGetUniqueThs( this.s.dt, d( ">thead", a.header )[0] );
                d( b ).each( function( a )
                {
                    n = c[a];
                    this.style.width = f.s.aiInnerWidths[n] + "px"
                } );
                null !== f.s.dt.nTFoot && (b = this.s.dt.oApi._fnGetUniqueThs( this.s.dt,
                    d( ">tfoot", a.footer )[0] ), d( b ).each( function( a )
                {
                    n = c[a];
                    this.style.width = f.s.aiInnerWidths[n] + "px"
                } ))
            ...
            }, _fnEqualiseHeights: function( a, b, c )
            {
                if (!("none" == this.s.sHeightMatch && "thead" !== a && "tfoot" !== a)) {
                    var g, f, e = b.getElementsByTagName( a )[0], c = c.getElementsByTagName( a )[0], a = d( ">" + a + ">tr:eq(0)",
                        b ).children( ":first" );
                    a.outerHeight();
                    a.height();
                    for (var e = this._fnGetTrNodes( e ), b = this._fnGetTrNodes( c ), h = [], c = 0, a = b.length; c < a; c++) {
                        g = e[c].offsetHeight, f = b[c].offsetHeight, g = f > g ? f : g, "semiauto" == this.s.sHeightMatch &&
                        (e[c]._DTTC_iHeight = g), h.push( g );
                    }
                    c = 0;
                    for (a = b.length; c < a; c++) {
                        b[c].style.height = h[c] + "px", e[c].style.height = h[c] + "px"
                    }
                }
            }
        };
        k.defaults = {iLeftColumns: 1, iRightColumns: 0, fnDrawCallback: null, sHeightMatch: "semiauto"};
        k.version = "3.0.2";
        d.fn.dataTable.FixedColumns = k;
        return d.fn.DataTable.FixedColumns = k
    };
    "function" === typeof define && define.amd ? define( ["jquery", "datatables"],
        o ) : "object" === typeof exports ? o( require( "jquery" ),
        require( "datatables" ) ) : jQuery && !jQuery.fn.dataTable.FixedColumns && o( jQuery, jQuery.fn.dataTable )
})( window,
    document );
