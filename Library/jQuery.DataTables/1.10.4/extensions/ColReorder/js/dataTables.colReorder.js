...
(function( window, document, undefined )
{
    ...
    var factory = function( $, DataTable )
    {
        ...
        var ColReorder = function( dt, opts )
        {
            ...
            // 1.9 compatibility
                ...
                if (dt.fnSettings) {
                    ...
                    if (typeof dt === 'string') {
                        ...
                        if (dt.nodeName && dt.nodeName.toLowerCase() === 'table') {
                            // Table node
            ...
            oDTSettings.oApi._fnCallbackReg( oDTSettings, 'aoDestroyCallback', $.proxy( this._fnDestroy, this ),
                'ColReorder' );
