...
(function( n, q, r )
{
    function o( b )
    {
        for (var f = [], a = 0, e = b.length; a < e; a++) {
            f[b[a]] = a;
        }
        return f
    }
    ...
    function p( b, f, a )
    {
        for (var e = [], c = 0, d = b.childNodes.length; c < d; c++) {
            1 == b.childNodes[c].nodeType && e.push( b.childNodes[c] );
        }
        f = e[f];
    ...
    {
        var e = $.fn.dataTable.Api ? !0 : !1, c, d, j, i, m = b.aoColumns.length, g, h;
        g = function( a, c, b )
        {
            if (a[c]) {
                var e = a[c].split( "." ), d = e.shift();
                isNaN( 1 * d ) ||
                (a[c] = b[1 * d] + "." + e.join( "." ))
            }
        };
        if (f != a) {
            if (0 > f || f >= m) {
                this.oApi._fnLog( b, 1, "ColReorder 'from' index is out of bounds: " + f );
            } else {
                if (0 > a || a >= m) {
                    this.oApi._fnLog( b, 1, "ColReorder 'to' index is out of bounds: " + a );
                } else {
                    j = [];
                    c = 0;
                    for (d = m; c < d; c++) {
                    ...
                    var k = o( j );
                    c = 0;
                    for (d = b.aaSorting.length; c < d; c++) {
                        b.aaSorting[c][0] = k[b.aaSorting[c][0]];
                    }
                    if (null !== b.aaSortingFixed) {
                        c = 0;
                        for (d = b.aaSortingFixed.length; c < d; c++) {
                            b.aaSortingFixed[c][0] = k[b.aaSortingFixed[c][0]]
                        }
                    }
                    c = 0;
                    for (d = m; c < d; c++) {
                        h = b.aoColumns[c];
                        j = 0;
                        for (i = h.aDataSort.length; j < i; j++) {
                            h.aDataSort[j] = k[h.aDataSort[j]];
                        }
                        e && (h.idx = k[h.idx])
                    }
                    ...
                    c = 0;
                    for (d = m; c < d; c++) {
                        h = b.aoColumns[c], "number" == typeof h.mData ? (h.mData = k[h.mData], b.oApi._fnColumnOptions( b,
                            c, {} )) : $.isPlainObject( h.mData ) && (g( h.mData, "_", k ), g( h.mData, "filter",
                            k ), g( h.mData, "sort", k ), g( h.mData, "type", k ), b.oApi._fnColumnOptions( b, c, {} ));
                    }
                    if (b.aoColumns[f].bVisible) {
                        ...
                        i && c < m;) {
                            i = this.oApi._fnColumnIndexToVisible( b, c ), c++;
                        }
                        ...
                        c = 0;
                        for (d = b.aoData.length; c < d; c++) {
                            null !== b.aoData[c].nTr && p( b.aoData[c].nTr, j, i )
                        }
                    }
                    l( b.aoColumns, f, a );
                    ...
                    c = 0;
                    for (d = b.aoData.length; c < d; c++) {
                        g = b.aoData[c], e ? (g.anCells && l( g.anCells, f,
                            a ), "dom" !== g.src && $.isArray( g._aData ) && l( g._aData, f,
                            a )) : ($.isArray( g._aData ) &&
                        l( g._aData, f, a ), l( g._anHidden, f, a ));
                    }
                    c = 0;
                    for (d = b.aoHeader.length; c < d; c++) {
                        l( b.aoHeader[c], f, a );
                    }
                    if (null !== b.aoFooter) {
                        c = 0;
                        for (d = b.aoFooter.length; c < d; c++) {
                            l( b.aoFooter[c], f, a )
                        }
                    }
                    ...
                    c = 0;
                    for (d = m; c < d; c++) {
                        $( b.aoColumns[c].nTh ).off( "click.DT" ), this.oApi._fnSortAttachListener( b,
                            b.aoColumns[c].nTh, c );
                    }
                    $( b.oInstance ).trigger( "column-reorder", [b, {iFrom: f, iTo: a, aiInvertMapping: k}] )
                }
            }
        }
    };
    n = function( b )
    {
        ...
        f.prototype = {
            ...
            }, _fnConstruct: function()
            {
                ...
                for (c = 0; c < b; c++)c > this.s.fixed - 1 && c < b - this.s.fixedRight && this._fnMouseListener( c,
                ...
                if (d)if (a.s.dt._bInitComplete)b = o( d ), a._fnOrderColumns.call( a, b ); else {
                    var f = !1;
            ...
            {
                if (a.length != this.s.dt.aoColumns.length)this.s.dt.oInstance.oApi._fnLog( this.s.dt, 1,
                    "ColReorder - array reorder does not match known number of columns. Skipping." ); else {
                    for (var e =
                        0, c = a.length; e < c; e++) {
                        var d = b.inArray( e, a );
            ...
            {
                var c =
                    this, d = b( a.target ).closest( "th, td" ).offset(), f = parseInt( b( e ).attr( "data-column-index" ),
                    10 );
                f !== r && (this.s.mouse.startX = a.pageX, this.s.mouse.startY = a.pageY, this.s.mouse.offsetX = a.pageX - d.left, this.s.mouse.offsetY = a.pageY - d.top, this.s.mouse.target = this.s.dt.aoColumns[f].nTh, this.s.mouse.targetIndex = f, this.s.mouse.fromIndex = f, this._fnRegions(), b( q ).on( "mousemove.ColReorder",
                    function( a )
                    {
            ...
            }, _fnMouseMove: function( a )
            {
                if (null ===
                    this.dom.drag) {
                    if (5 > Math.pow( Math.pow( a.pageX - this.s.mouse.startX,
                            2 ) + Math.pow( a.pageY - this.s.mouse.startY, 2 ), 0.5 ))return;
                    this._fnCreateDragNode()
                }
                this.dom.drag.css( {left: a.pageX - this.s.mouse.offsetX, top: a.pageY - this.s.mouse.offsetY} );
                for (var b = !1, c = this.s.mouse.toIndex, d = 1, f = this.s.aoTargets.length; d < f; d++)if (a.pageX < this.s.aoTargets[d - 1].x + (this.s.aoTargets[d].x - this.s.aoTargets[d - 1].x) / 2) {
                ...
                this.s.init.bRealtime && c !== this.s.mouse.toIndex && (this.s.dt.oInstance.fnColReorder( this.s.mouse.fromIndex,
            ...
            }, _fnMouseUp: function()
            {
                ...
                null !== this.dom.drag && (this.dom.drag.remove(), this.dom.pointer.remove(), this.dom.drag = null,
                    this.dom.pointer = null, this.s.dt.oInstance.fnColReorder( this.s.mouse.fromIndex,
                    this.s.mouse.toIndex ), this._fnSetColumnIndexes(), ("" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY) && this.s.dt.oInstance.fnAdjustColumnSizing(), null !== this.s.dropCallback && this.s.dropCallback.call( this ), this.s.dt.oInstance.oApi._fnSaveState( this.s.dt ))
            }, _fnRegions: function()
            {
                var a = this.s.dt.aoColumns;
                this.s.aoTargets.splice( 0, this.s.aoTargets.length );
                this.s.aoTargets.push( {x: b( this.s.dt.nTable ).offset().left, to: 0} );
            ...
            }, _fnCreateDragNode: function()
            {
                ...
                this.dom.pointer = b( "<div></div>" ).addClass( "DTCR_pointer" ).css( {
                    position: "absolute",
                    top: a ? b( "div.dataTables_scroll",
                        this.s.dt.nTableWrapper ).offset().top : b( this.s.dt.nTable ).offset().top,
                    height: a ? b( "div.dataTables_scroll",
                        this.s.dt.nTableWrapper ).height() : b( this.s.dt.nTable ).height()
                } ).appendTo( "body" )
            },
            _fnDestroy: function()
            {
                var a, e;
                a = 0;
                for (e = this.s.dt.aoDrawCallback.length; a < e; a++)if ("ColReorder_Pre" === this.s.dt.aoDrawCallback[a].sName) {
        ...
        "function" == typeof b.fn.dataTable && "function" == typeof b.fn.dataTableExt.fnVersionCheck && b.fn.dataTableExt.fnVersionCheck( "1.9.3" ) ? b.fn.dataTableExt.aoFeatures.push( {
            ...
            {
                var b = a.oInstance;
                a._colReorder ? b.oApi._fnLog( a, 1,
                    "ColReorder attempted to initialise twice. Ignoring second" ) : (b = a.oInit, new f( a,
                    b.colReorder || b.oColReorder || {} ));
                return null
    ...
    "function" === typeof define && define.amd ? define( [
        "jquery",
        "datatables"
    ], n ) : "object" === typeof exports ? n( require( "jquery" ),
        require( "datatables" ) ) : jQuery && !jQuery.fn.dataTable.ColReorder && n( jQuery, jQuery.fn.dataTable )
})( window, document );
