	 ...
	 */
            ...
            "_fnScroll": function()
            {
                ...
                if (iScrollTop < this.s.redrawTop || iScrollTop > this.s.redrawBottom) {
                    ...
                    if (Math.abs( iScrollTop - this.s.lastScrollTop ) > heights.viewport || this.s.ani) {
                        iTopRow = parseInt( this._domain( 'physicalToVirtual', iScrollTop ) / heights.row,
                            10 ) - preRows;
            ...
            "_fnInfo": function()
            {
                ...
                var
                    ...
                    iPossibleEnd = Math.ceil( this.fnPixelsToRow( iScrollTop + this.s.heights.viewport, false,
                        this.s.ani ) ),
...
// Define as an AMD module if possible
    if (typeof define === 'function' && define.amd) {
        ...
        if (typeof exports === 'object') {
            ...
            if (jQuery && !jQuery.fn.dataTable.Scroller) {
