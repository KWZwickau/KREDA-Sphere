        ...
        (function( $, window, document )
        {
            ...
            TableTools.prototype = {
                ...
                "_fnCreateButton": function( oConfig, bCollectionButton )
                {
                    ...
                    if (oConfig.sAction.match( /flash/ )) {
                        ...
                        if (oConfig.sAction == "text") {
                            ...
                            if (oConfig.sAction == "div") {
                                this._fnTextConfig( nButton, oConfig );
                            }
                            else {
                                if (oConfig.sAction == "collection") {
                                    this._fnTextConfig( nButton, oConfig );
                ...
                "_fnRowSelect": function( src, e )
                {
                    ...
                    if (this.s.select.preRowSelect !== null && !this.s.select.preRowSelect.call( this, e, anSelected,
                            true )) {
                        return;
                    }
                ...
                "_fnRowDeselect": function( src, e )
                {
                    ...
                    // User defined pre-selection function
                    if (this.s.select.preRowSelect !== null && !this.s.select.preRowSelect.call( this, e,
                            anDeselectedTrs, false )) {
                        return;
                    }
                ...
                "_fnGetDataTablesData": function( oConfig )
                {
                    ...
                    for (j = 0, jLen = aDataIndex.length; j < jLen; j++) {
                        ...
                        if (oConfig.bOpenRows) {
                            ...
                            if (arr.length === 1) {
                                sLoopData = this._fnBoundData( $( 'td', arr[0].nTr ).html(), oConfig.sFieldBoundary,
                                    regex );
            ...
            TableTools.BUTTONS = {
                ...
                "copy": $.extend( {}, TableTools.buttonBase, {
                    ...
                    "fnComplete": function( nButton, oConfig, flash, text )
                    {
                        ...
                        if (this.s.dt.nTFoot !== null && oConfig.bFooter) {
                            lines--;
                        }
