...
(function( n, k, q )
{
    var p = function( m, p )
    {
        var g = {
            version: "1.0.4-TableTools2", clients: {}, moviePath: "", nextId: 1, $: function( a )
            {
                ...
                {
                    this.className = this.className.replace( RegExp( "\\s*" + a + "\\s*" ), " " ).replace( /^\s+/,
                        "" ).replace( /\s+$/, "" )
        ...
        g.Client.prototype = {
            ...
            glue: function( a, b )
            {
                ...
                this.domElement && (this.domElement.appendChild( this.div ), this.div.innerHTML = this.getHTML( d.width,
                    d.height ).replace( /&/g, "&amp;" ))
            },
        ...
        TableTools.prototype = {
            ...
            }, fnGetTitle: function( a )
            {
                ...
                return 4 > "¡".toString().length ? b.replace( /[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g,
            ...
            }, _fnCreateButton: function( a, b )
            {
                ...
                if (a.sAction.match( /flash/ )) {
                    ...
                    "text" == a.sAction ? this._fnTextConfig( c, a ) : "div" == a.sAction ? this._fnTextConfig( c,
                        a ) : "collection" == a.sAction && (this._fnTextConfig( c, a ), this._fnCollectionConfig( c,
                        a ));
                }
                if (-1 !== this.s.dt.iTabIndex) {
                    e( c ).attr( "tabindex", this.s.dt.iTabIndex ).attr( "aria-controls",
                        this.s.dt.sTableId ).on( "keyup.DTTT", function( a )
                        {
            ...
            {
                !(null !== b && "collection" == b.sExtends) && null !== this.dom.collection.collection && (e( this.dom.collection.collection ).animate( {opacity: 0},
                    500, function()
                    {
                        this.style.display = "none"
            ...
            }, _fnRowSelectConfig: function()
            {
                if (this.s.master) {
                    ...
                    {
                        if (a.shiftKey) {
                            e( b.nTBody ).css( "-moz-user-select", "none" ).one( "selectstart.DTTT_Select",
                                "tr", function()
                                {
                                    return !1
                                } )
                        ...
                        if (d.parentNode ==
                            ...
                            if (f.type == "os") {
                                if (c.ctrlKey || c.metaKey) {
                                    a.fnIsSelected( d ) ? a._fnRowDeselect( d,
                                        c ) : a._fnRowSelect( d, c );
                                } else {
                                    if (c.shiftKey) {
                                        var i = a.s.dt.aiDisplay.slice(), h = e.inArray( f.lastRow,
                                            i ), o = e.inArray( j,
                                            i );
                                        ...
                                        if (a.fnIsSelected( d ) && a.fnGetSelected().length ===
                                            1) {
            ...
            }, _fnFlashConfig: function( a, b )
            {
                ...
                "flash_save" == b.sAction ?
                    (d.setAction( "save" ), d.setCharSet( "utf16le" == b.sCharSet ? "UTF16LE" : "UTF8" ), d.setBomInc( b.bBomInc ), d.setFileName( b.sFileName.replace( "*",
                        this.fnGetTitle( b ) ) )) : "flash_pdf" == b.sAction ? (d.setAction( "pdf" ), d.setFileName( b.sFileName.replace( "*",
                    this.fnGetTitle( b ) ) )) : d.setAction( "copy" );
            ...
            {
                var b, c, d, f, j, i = [], h = "", g = this.s.dt, k, l = RegExp( a.sFieldBoundary,
                    "g" ), n = this._fnColumnTargets( a.mColumns );
                ...
                if (a.bHeader) {
                    ...
                    for (c = g.aoColumns.length; b < c; b++) {
                        n[b] && (h = g.aoColumns[b].sTitle.replace( /\n/g,
                            ...
                            "" ), h = this._fnHtmlDecode( h ), j.push( this._fnBoundData( h, a.sFieldBoundary, l ) ));
                    }
                ...
                m = (d = "none" !== this.s.select.type && d && 0 !== f.length) ? f : p.Api ? (new p.Api( g )).rows( a.oSelectorOpts ).indexes().flatten().toArray() : g.oInstance.$( "tr",
                    a.oSelectorOpts ).map( function( a, b )
                {
                ...
                for (f = m.length; d < f; d++) {
                    ...
                    b = 0;
                    for (c = g.aoColumns.length; b < c; b++) {
                        n[b] && (h = g.oApi._fnGetCellData( g, m[d], b,
                            "display" ), a.fnCellRender ? h = a.fnCellRender( h, b, k,
                            m[d] ) + "" : "string" == typeof h ? (h = h.replace( /\n/g,
                            " " ), h = h.replace( /<img.*?\s+alt\s*=\s*(?:"([^"]+)"|'([^']+)'|([^\s>]+)).*?>/gi,
                            "$1$2$3" ), h = h.replace( /<.*?>/g, "" )) : h += "", h = h.replace( /^\s+/,
                            "" ).replace( /\s+$/, "" ), h = this._fnHtmlDecode( h ), j.push( this._fnBoundData( h,
                            a.sFieldBoundary, l ) ));
                    }
                    i.push( j.join( a.sFieldSeperator ) );
                    ...
                    {
                        return a.nParent === k
                    } ), 1 === b.length && (h = this._fnBoundData( e( "td", b[0].nTr ).html(), a.sFieldBoundary,
                        l ), i.push( h )))
                }
                if (a.bFooter && null !== g.nTFoot) {
                    ...
                    for (c = g.aoColumns.length; b < c; b++) {
                        n[b] && null !== g.aoColumns[b].nTf && (h = g.aoColumns[b].nTf.innerHTML.replace( /\n/g,
                            " " ).replace( /<.*?>/g, "" ), h = this._fnHtmlDecode( h ), j.push( this._fnBoundData( h,
                            a.sFieldBoundary, l ) ));
                    }
                    i.push( j.join( a.sFieldSeperator ) )
                }
            ...
            }, _fnChunkData: function( a, b )
            {
                for (var c = [], d = a.length, f = 0; f < d; f += b) {
                    f + b < d ? c.push( a.substring( f,
                        f + b ) ) : c.push( a.substring( f, d ) );
                }
                return c
            ...
            }, _fnPrintStart: function( a )
            {
                ...
                if ("" !== c.oScroll.sX || "" !== c.oScroll.sY) {
                    this._fnPrintScrollStart( c ), e( this.s.dt.nTable ).bind( "draw.DTTT_Print",
                        function()
                        {
            ...
            {
                for (var a =
                    this.dom.print.hidden, b = 0, c = a.length; b < c; b++) {
        ...
        {
            for (var a =
                [], b = 0, c = TableTools._aInstances.length; b < c; b++) {
        ...
        TableTools._fnEventDispatch =
            function( a, b, c, d )
            {
                for (var f = TableTools._aListeners, e = 0, g = f.length; e < g; e++) {
                    a.dom.table == f[e].that.dom.table && f[e].type == b && f[e].fn( c,
                        d )
                }
            };
        ...
        TableTools.BUTTONS = {
            ...
            copy: e.extend( {}, TableTools.buttonBase, {
                ...
                fnComplete: function( a, b, c, d )
                {
                    ...
                    this.fnInfo( "<h6>Table copied</h6><p>Copied " + a + " row" + (1 == a ? "" : "s") + " to the clipboard.</p>",
                        1500 )
                }
            } ),
    ...
    "function" === typeof define && define.amd ? define( ["jquery", "datatables"],
        p ) : "object" === typeof exports ? p( require( "jquery" ),
        require( "datatables" ) ) : jQuery && !jQuery.fn.dataTable.TableTools && p( jQuery, jQuery.fn.dataTable )
})( window, document );
