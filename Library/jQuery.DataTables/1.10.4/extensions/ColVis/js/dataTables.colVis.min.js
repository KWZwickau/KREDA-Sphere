...
(function( j, i, k )
{
    j = function( d )
    {
        ...
        e.prototype = {
            ...
            {
                for (var a = this.dom.buttons.length - 1; 0 <= a; a--) {
                    this.dom.collection.removeChild( this.dom.buttons[a] );
                }
            ...
            }, _fnConstruct: function( a )
            {
                ...
                this.dom.button = d( "<button />",
                    {"class": !this.s.dt.bJUI ? "ColVis_Button ColVis_MasterButton" : "ColVis_Button ColVis_MasterButton ui-button ui-state-default"} ).append( "<span>" + this.s.buttonText + "</span>" ).bind( "mouseover" == this.s.activate ? "mouseover" : "click",
                    function( a )
                    {
                        a.preventDefault();
                        b._fnCollectionShow()
                ...
                this._fnAddButtons();
                c = 0;
                for (f = this.s.dt.aoColumns.length; c < f; c++) {
                    this.s.abOriginal.push( this.s.dt.aoColumns[c].bVisible );
                }
                ...
                {
                    c = 0;
                    for (f = b.s.aiExclude.length; c < f; c++) {
                        b.s.aiExclude[c] = e.aiInvertMapping[b.s.aiExclude[c]];
                    }
            ...
            _fnApplyCustomisation: function( a )
            {
                ...
                if (a) {
                    for (var c = 0, f = a.length; c < f; c++) {
                        if (a[c].title && (b[c].sTitle = a[c].title), a[c].columns) {
                            b[c].aiColumns = a[c].columns
                        }
                    }
                }
            }, _fnDrawCallback: function()
            {
                for (var a = this.s.dt.aoColumns, b = this.dom.buttons, c = this.s.aoGroups, f, g = 0, h = b.length; g < h; g++) {
                    f = b[g], f.__columnIdx !== k &&
                ...
                for (f = c.length; b < f; b++) {
                    ...
                    if (g) {
                        d( "input", this.dom.groupButtons[b] ).prop( "checked", !0 ), d( "input",
                            this.dom.groupButtons[b] ).prop( "indeterminate", !1 );
                    } else {
                        a:{
                            g = c[b].aiColumns;
                            h = 0;
                        ...
                        g ? (d( "input", this.dom.groupButtons[b] ).prop( "checked", !1 ), d( "input",
                            this.dom.groupButtons[b] ).prop( "indeterminate",
            ...
            }, _fnAddGroups: function()
            {
                ...
                if ("undefined" != typeof this.s.aoGroups) {
                    for (var b = 0, c = this.s.aoGroups.length; b < c; b++) {
                        a = this._fnDomGroupButton( b ), this.dom.groupButtons.push( a ), this.dom.buttons.push( a ), this.dom.collection.appendChild( a )
                    }
                }
            }, _fnAddButtons: function()
            {
                ...
                if (-1 === d.inArray( "all",
                    ...
                    for (var c = 0, f = b.length; c < f; c++) {
                        -1 === d.inArray( c,
                            this.s.aiExclude ) && (a = this._fnDomColumnButton( c ), a.__columnIdx =
                ...
                this.s.showAll && (a = this._fnDomShowXButton( this.s.showAll,
                    !0 ), a.className += " ColVis_ShowAll", this.dom.buttons.push( a ));
                this.s.showNone && (a = this._fnDomShowXButton( this.s.showNone,
                    !1 ), a.className += " ColVis_ShowNone", this.dom.buttons.push( a ));
            ...
            }, _fnDomRestoreButton: function()
            {
                ...
                {
                    for (var b = 0, c = a.s.abOriginal.length; b < c; b++) {
                        a.s.dt.oInstance.fnSetColumnVis( b,
                            a.s.abOriginal[b], !1 );
                    }
                    a._fnAdjustOpenRows();
            ...
            }, _fnDomShowXButton: function( a, b )
            {
                ...
                {
                    for (var a = 0, d = c.s.abOriginal.length; a < d; a++) {
                        -1 === c.s.aiExclude.indexOf( a ) && c.s.dt.oInstance.fnSetColumnVis( a,
                            b, !1 );
                    }
                    c._fnAdjustOpenRows();
            ...
            }, _fnDomGroupButton: function( a )
            {
                ...
                return d( '<li class="ColVis_Special ' + (this.s.dt.bJUI ? "ui-button ui-state-default" : "") + '"><label><input type="checkbox" /><span>' + c.sTitle + "</span></label></li>" ).click( function( a )
                {
                    ...
                    for (a = 0; a < c.aiColumns.length; a++) {
                        b.s.dt.oInstance.fnSetColumnVis( c.aiColumns[a], g )
                    }
                } )[0]
            }, _fnDomColumnButton: function( a )
            {
                var b = this, c = this.s.dt.aoColumns[a], f = this.s.dt, c = null === this.s.fnLabel ? c.sTitle : this.s.fnLabel( a,
                    c.sTitle, c.nTh );
                return d( "<li " + (f.bJUI ? 'class="ui-button ui-state-default"' : "") + '><label><input type="checkbox" /><span>' + c + "</span></label></li>" ).click( function( c )
                {
                    ...
                    f.oFeatures.bServerSide ? (b.s.dt.oInstance.fnSetColumnVis( a, e,
                        !1 ), b.s.dt.oInstance.fnAdjustColumnSizing( !1 ), ("" !== f.oScroll.sX || "" !== f.oScroll.sY) && b.s.dt.oInstance.oApi._fnScrollDraw( b.s.dt ), b._fnDrawCallback()) : b.s.dt.oInstance.fnSetColumnVis( a,
                        e );
            ...
            }, _fnDataTablesApiIndex: function()
            {
                for (var a = 0, b = this.s.dt.oInstance.length; a < b; a++) {
                    if (this.s.dt.oInstance[a] == this.s.dt.nTable) {
                        return a;
                    }
                }
                return 0
            ...
            {
                return d( "<ul />",
                    {"class": !this.s.dt.bJUI ? "ColVis_collection" : "ColVis_collection ui-buttonset ui-buttonset-multi"} ).css( {
                    display: "none",
                    opacity: 0,
            ...
            {
                var a = this, b = d( "<div></div>" ).addClass( "ColVis_collectionBackground" ).css( "opacity",
                    0 ).click( function()
                {
            ...
            }, _fnCollectionShow: function()
            {
                ...
                var c = this.dom.collection, f = this.dom.background, e = parseInt( b.left,
                    10 ), h = parseInt( b.top + d( this.dom.button ).outerHeight(),
                    10 );
            ...
            {
                for (var a = this.s.dt.aoOpenRows, b = this.s.dt.oApi._fnVisbleColumns( this.s.dt ), c = 0, d = a.length; c < d; c++) {
                    a[c].nTr.getElementsByTagName( "td" )[0].colSpan = b
                }
            }
        };
        e.fnRebuild = function( a )
        {
            ...
            for (var c = 0, d = e.aInstances.length; c < d; c++) {
                ("undefined" == typeof a || b == e.aInstances[c].s.dt.nTable) && e.aInstances[c].fnRebuild()
            }
        };
        e.defaults =
        {
    ...
    "function" === typeof define && define.amd ? define( ["jquery", "datatables"],
        j ) : "object" === typeof exports ? j( require( "jquery" ),
        require( "datatables" ) ) : jQuery && !jQuery.fn.dataTable.ColVis && j( jQuery, jQuery.fn.dataTable )
})( window, document );
