...
XRegExp = XRegExp || function( n )
{
    ...
    function o( n, r, u )
    {
        ...
        return u && (f = i.replace.call( f, new RegExp( "[" + u + "]+", "g" ),
            "" )), n = n.xregexp && !n.xregexp.isNative ? v( t( n.source, f ),
            n.xregexp.captureNames ? n.xregexp.captureNames.slice( 0 ) : null ) : v( new RegExp( n.source, f ), null,
            !0 )
    }
    ...
    function d( n )
    {
        return n = n || {}, n === "all" || n.all ? n = {natives: !0, extensibility: !0} : s( n,
            "string" ) && (n = t.forEach( n, /[^\s,]+/, function( n )
        {
            this[n] = !0
        }, {} )), n
    }
    ...
    function ut( n, t, i, u )
    {
        ...
        try {
            while (o--) {
                if (f = p[o], (f.scope === "all" || f.scope === i) && (!f.trigger || f.trigger.call( u )) && (f.pattern.lastIndex = t, e = r.exec.call( f.pattern,
                        n ), e && e.index === t)) {
    ...
    }, et = /\$(?:{([\w$]+)}|(\d\d?|[\s\S]))/g, h = /([\s\S])(?=[\s\S]*\1)/g, nt = /^(?:[?*+]|{\d+(?:,\d*)?})\??/, ft = i.exec.call( /()??/,
            "" )[1] === n, l = RegExp.prototype.sticky !== n, y = !1, w = "gim" + (l ? "y" : "");
    return t = function( r, u )
    {
        ...
        if (r = r === n ? "" : String( r ), u = u === n ? "" : String( u ), i.match.call( u,
                h )) {
        ...
        } ), t.forEach( u, /[\s\S]/, function( n )
        {
            ...
            c = ut( r, f, a,
                b ), c ? (l.push( c.output ), f += c.match[0].length || 1) : (s = i.exec.call( it[a],
                r.slice( f ) ), s ? (l.push( s[0] ), f += s[0].length) : (p = r.charAt( f ), p === "[" ? a = rt : p === "]" && (a = e), l.push( p ), ++f));
        }
        return v( new RegExp( l.join( "" ), i.replace.call( u, /[^gimy]+/g, "" ) ),
            b.hasNamedCapture ? b.captureNames : null )
    }, c = {
        on: function( n, t, r )
        {
            r = r || {}, n && p.push( {
    ...
    }, t.exec = function( n, t, i, u )
    {
        ...
        return e.lastIndex = i = i || 0, f = r.exec.call( e,
            n ), u && f && f.index !== i && (f = null), t.global && (t.lastIndex = f ? e.lastIndex : 0), f
    ...
    }, t.replace = function( i, u, f, e )
    {
        ...
        return c ? (e === n && u.global && (e = "all"), s = o( u, e === "all" ? "g" : "",
            e === "all" ? "" : "g" )) : e === "all" && (s = new RegExp( t.escape( String( u ) ),
            "g" )), h = r.replace.call( String( i ), s, f ), c && u.global && (u.lastIndex = 0), h
    ...
    }, t.union = function( n, i )
    {
        ...
        for (u = 0; u < n.length; ++u) {
            r = n[u], t.isRegExp( r ) ? (f = o, h = r.xregexp && r.xregexp.captureNames || [], e.push( t( r.source ).source.replace( l,
                c ) )) : e.push( t.escape( r ) );
        }
        return t( e.join( "|" ), i )
    }, t.version = "2.0.0", r.exec = function( t )
    {
        ...
        if (this.global || (o = this.lastIndex), r = i.exec.apply( this, arguments ), r) {
            if (!ft && r.length > 1 && a( r, "" ) > -1 && (e = new RegExp( this.source,
                    i.replace.call( g( this ), "g", "" ) ), i.replace.call( String( t ).slice( r.index ), e, function()
                {
    ...
    }, r.replace = function( n, r )
    {
        ...
        return e ? (n.xregexp && (u = n.xregexp.captureNames), n.global || (o = n.lastIndex)) : n += "", s( r,
            "function" ) ? f = i.replace.call( String( this ), n, function()
        {
            var t = arguments, i;
            if (u) {
                for (t[0] = String( t[0] ), i = 0; i < u.length; ++i) {
                    u[i] && (t[0][u[i]] = t[i + 1]);
                }
            }
    ...
    }, r.split = function( r, u )
    {
        ...
        {
            n.index + n[0].length > o && (f.push( e.slice( o,
                n.index ) ), n.length > 1 && n.index < e.length && Array.prototype.push.apply( f,
                n.slice( 1 ) ), s = n[0].length, o = n.index + s)
        } ), o === e.length ? (!i.test.call( r,
            "" ) || s) && f.push( "" ) : f.push( e.slice( o ) ), r.lastIndex = h, f.length > u ? f.slice( 0, u ) : f
...
// references to SyntaxHighlighter.whatever...
                ...
                items: {
                    ...
                    expandSource: {
                        getHtml: function( highlighter )
                        {
                            ...
                            return sh.toolbar.getButtonHtml( highlighter, 'expandSource',
        ...
        function parseParams( str )
        {
            ...
            if (a) {
                ...
                if (str && str.indexOf( 'multiline' ) !== -1) {
            ...
            if (match.attributes != null) {
                ...
                while ((attributes = XRegExp.exec( code, regex, pos )) != null) {
                    ...
                    result.push( new constructor( attributes.value,
                        match.index + attributes.index + attributes[0].indexOf( attributes.value ), 'string' ) );
