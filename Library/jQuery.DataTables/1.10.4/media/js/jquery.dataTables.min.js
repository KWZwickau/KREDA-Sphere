    ...
    var O = function( g )
    {
        function V( a )
        {
            ...
            g.each( a, function( d )
            {
                if ((b = d.match( /^([^A-Z]+?)([A-Z])/ )) && -1 !== "a aa ai ao as b fn i m o s ".indexOf( b[1] + " " )) {
                    c = d.replace( b[0],
                        b[2].toLowerCase() ), e[c] = d, "o" === b[1] && V( a[d] )
                }
            } );
            a._hungarianMap = e
        }
        ...
        function G( a, b, c )
        {
            ...
            g.each( b, function( d )
            {
                e = a._hungarianMap[d];
                if (e !== l && (c || b[e] === l)) {
                    "o" === e.charAt( 0 ) ? (b[e] || (b[e] = {}), g.extend( !0, b[e],
                        b[d] ), G( a[e], b[e], c )) : b[e] = b[d]
                }
            } )
        }
        ...
        function O( a )
        {
            ...
            !a.sEmptyTable && (c && "No data available in table" === b.sEmptyTable) && D( a, a, "sZeroRecords",
                "sEmptyTable" );
            !a.sLoadingRecords && (c && "Loading..." === b.sLoadingRecords) && D( a, a, "sZeroRecords",
                "sLoadingRecords" );
        ...
        function ja( a, b, c )
        {
            ...
            c !== l && null !== c && (eb( c ), G( p.defaults.column,
                c ), c.mDataProp !== l && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), g.extend( b,
                c ), D( b, c, "sWidth",
                "sWidthOrig" ), "number" === typeof c.iDataSort && (b.aDataSort = [c.iDataSort]), D( b, c,
                "aDataSort" ));
                    ...
                    for (h = o.length; f < h; f++) {
                        if ("number" === typeof o[f] && 0 <= o[f]) {
                            ...
                            if ("number" === typeof o[f] && 0 > o[f]) {
                                ...
                                if ("string" === typeof o[f]) {
                                    i = 0;
                                    for (j = m.length; i < j; i++) {
                                        ("_all" == o[f] || g( m[i].nTh ).hasClass( o[f] )) && e( i,
                                            n )
                                    }
                                }
                            }
        ...
        function v( a, b, c, e )
        {
            var d = a.iDraw, f = a.aoColumns[c], h = a.aoData[b]._aData, i = f.sDefaultContent, c = f.fnGetData( h, e,
                {settings: a, row: b, col: c} );
            if (c === l) {
                return a.iDrawError != d && null === i && (R( a, 0,
                    "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}" : "'" + f.mData + "'") + " for row " + b,
                    4 ), a.iDrawError = d), i;
            }
        ...
        function ma( a, b, c, e )
        {
            var d = [], f = b.firstChild,
                ...
                {
                    if (c === l || c === i) {
                        h = n[i], j = g.trim( a.innerHTML ), h && h._bAttrSrc ? (Q( h.mData._ )( e,
                            j ), o( h.mData.sort, a ), o( h.mData.type, a ), o( h.mData.filter,
                            a )) : m ? (h._setter || (h._setter = Q( h.mData )), h._setter( e, j )) : e[i] = j;
                    }
                    i++
                };
            if (f) {
        ...
        function ib( a )
        {
            var b, c, e, d, f, h = a.nTHead, i = a.nTFoot, j = 0 === g( "th, td",
                    h ).length, n = a.oClasses, m = a.aoColumns;
            j && (d = g( "<tr/>" ).appendTo( h ));
            b = 0;
            for (c =
                     m.length; b < c; b++) {
                f = m[b], e = g( f.nTh ).addClass( f.sClass ), j && e.appendTo( d ), a.oFeatures.bSort && (e.addClass( f.sSortingClass ), !1 !== f.bSortable && (e.attr( "tabindex",
                    a.iTabIndex ).attr( "aria-controls", a.sTableId ), Na( a, f.nTh,
                    b ))), f.sTitle != e.html() && e.html( f.sTitle ), Oa( a, "header" )( a, e, f, n );
            }
            j && da( a.aoHeader, h );
                    ...
                    c = f.sZeroRecords, 1 == a.iDraw && "ajax" == A( a ) ? c = f.sLoadingRecords : f.sEmptyTable && 0 === a.fnRecordsTotal() && (c = f.sEmptyTable), b[0] = g( "<tr/>",
                        {
                            ...
                            {valign: "top", colSpan: aa( a ), "class": a.oClasses.sRowEmpty} ).html( c ) )[0];
                }
            ...
            for (var f = a.sDom.split( "" ), h, i, j, n, m, o, k = 0; k < f.length; k++) {
                ...
                if ("<" == i) {
                    ...
                    if ("'" == n || '"' == n) {
                        ...
                        "H" == m ? m = b.sJUIHeader :
                        "F" == m && (m = b.sJUIFooter);
                        -1 != m.indexOf( "." ) ? (n = m.split( "." ), j.id = n[0].substr( 1,
                            n[0].length - 1 ), j.className = n[1]) : "#" == m.charAt( 0 ) ? j.id = m.substr( 1,
                    ...
                    if (">" == i) {
                        ...
                        if ("l" == i && e.bPaginate && e.bLengthChange) {
                            h = mb( a );
                        } else {
                            if ("f" == i && e.bFilter) {
                                h = nb( a );
                            } else {
                                if ("r" == i && e.bProcessing) {
                                    h = ob( a );
                                } else {
                                    if ("t" == i) {
                                        h = pb( a );
        ...
        function qa( a, b, c )
        {
            ...
            j = {
                ...
                {
                    var f = a.oApi._fnLog;
                    "parsererror" == c ? f( a, 0, "Invalid JSON response", 1 ) : 4 === b.readyState && f( a, 0,
                        "Ajax error", 7 );
                    B( a, !1 )
                }
            };
            ...
            a.fnServerData ? a.fnServerData.call( i, a.sAjaxSource, g.map( b, function( a, b )
            {
                ...
                {url: h || a.sAjaxSource} ) ) : g.isFunction( h ) ? a.jqXHR = h.call( i, b, c,
                a ) : (a.jqXHR = g.ajax( g.extend( j, h ) ), h.data = f)
        }
        ...
        function sb( a )
        {
            ...
            for (h = 0; h < c; h++) {
                n = b[h], m = f[h], j = "function" == typeof n.mData ? "function" : n.mData, l.columns.push( {
                    ...
                    k( "mDataProp_" + h, j ), e.bFilter && (k( "sSearch_" + h, m.sSearch ), k( "bRegex_" + h,
                    m.bRegex ), k( "bSearchable_" + h, n.bSearchable )), e.bSort && k( "bSortable_" + h, n.bSortable );
            }
        ...
        function nb( a )
        {
            var b = a.oClasses, c = a.sTableId, e = a.oLanguage, d = a.oPreviousSearch, f = a.aanFeatures, h = '<input type="search" class="' + b.sFilterInput + '"/>', i = e.sSearch, i = i.match( /_INPUT_/ ) ? i.replace( "_INPUT_",
                h ) : i + h, b = g( "<div/>", {
            ...
            } ).append( g( "<label/>" ).append( i ) ), f = function()
            {
                ...
                h ? ta( f, h ) : f ).bind( "keypress.DT", function( a )
            {
                if (13 == a.keyCode) {
                    return !1
                }
        ...
        function fa( a, b, c )
        {
            ...
            if ("ssp" != A( a )) {
                ...
                for (b = 0; b < d.length; b++) {
                    vb( a, d[b].sSearch, b,
                        d[b].bEscapeRegex !== l ? !d[b].bEscapeRegex : d[b].bRegex, d[b].bSmart,
        ...
        function wb( a )
        {
            for (var b = p.ext.search, c = a.aiDisplay, e, d, f = 0, h = b.length; f < h; f++) {
                for (var i = [], j = 0, g = c.length; j < g; j++) {
                    d = c[j], e = a.aoData[d], b[f]( a, e._aFilterData, d,
                        e._aData, j ) && i.push( d );
                }
                c.length = 0;
                c.push.apply( c, i )
        ...
        {
            if ("" !== b) {
                for (var h = a.aiDisplay, e = Pa( b, e, d,
                    f ), d = h.length - 1; 0 <= d; d--) {
        ...
        function qb( a )
        {
            ...
            c || (a.aoDrawCallback.push( {fn: Ab, sName: "information"} ), e.attr( "role", "status" ).attr( "aria-live",
                "polite" ), g( a.nTable ).attr( "aria-describedby", b + "_info" ));
            return e[0]
        }
        ...
        function Bb( a, b )
        {
            ...
            return b.replace( /_START_/g, c.call( a, e ) ).replace( /_END_/g,
                c.call( a, a.fnDisplayEnd() ) ).replace( /_MAX_/g,
                c.call( a, a.fnRecordsTotal() ) ).replace( /_TOTAL_/g, c.call( a, f ) ).replace( /_PAGE_/g,
                c.call( a, h ? 1 : Math.ceil( e / d ) ) ).replace( /_PAGES_/g, c.call( a, h ? 1 : Math.ceil( f / d ) ) )
        }
        ...
        function Sa( a, b, c )
        {
            ...
            0 === f || -1 === d ? e = 0 : "number" === typeof b ? (e = b * d, e > f && (e = 0)) : "first" == b ? e = 0 : "previous" == b ? (e = 0 <= d ? e - d : 0, 0 > e && (e = 0)) : "next" == b ? e + d < f && (e += d) : "last" == b ? e = Math.floor( (f - 1) / d ) * d : R( a,
                0, "Unknown paging action: " + b, 5 );
        ...
        function pb( a )
        {
            ...
            c = g( "<div/>", {"class": f.sScrollWrapper} ).append( g( "<div/>", {"class": f.sScrollHead} ).css( {
                ...
                width: c.sXInner || "100%"
            } ).append( j.removeAttr( "id" ).css( "margin-left",
                0 ).append( "top" === i ? h : null ).append( b.children( "thead" ) ) ) ) ).append( g( "<div/>",
            ...
            m && c.append( g( "<div/>", {"class": f.sScrollFoot} ).css( {
                ...
                0 ).append( "bottom" === i ? h : null ).append( b.children( "tfoot" ) ) ) ) );
        ...
        )
        {
            for (var e = 0, d = 0, f = b.length, h, g; d < f;) {
                ...
                for (g = c ? c[d].firstChild : null; h;) {
                    1 === h.nodeType && (c ? a( h, g, e ) : a( h,
                        e ), e++), h = h.nextSibling, g = c ? g.nextSibling : null;
                }
                d++
            }
        }
        ...
        function Fa( a )
        {
            var b = a.nTable, c = a.aoColumns, e = a.oScroll, d = e.sY, f = e.sX, h = e.sXInner, i = c.length, e = Z( a,
                "bVisible" ), j = g( "th", a.nTHead ), n = b.getAttribute( "width" ), m = b.parentNode, o = !1, k, l;
            ...
            if (!o && !f && !d && i == aa( a ) && i == j.length) {
                ...
                i = g( b ).clone().empty().css( "visibility",
                    "hidden" ).removeAttr( "id" ).append( g( a.nTHead ).clone( !1 ) ).append( g( a.nTFoot ).clone( !1 ) ).append( g( "<tbody><tr/></tbody>" ) );
                ...
                if (a.aoData.length) {
                    for (k = 0; k < e.length; k++) {
                        o = e[k], l = c[o], g( Db( a,
                            o ) ).clone( !1 ).append( l.sContentPadding ).appendTo( p );
                    }
                }
                i.appendTo( m );
                f && h ? i.width( h ) : f ? (i.css( "width",
                    "auto" ), i.width() < m.offsetWidth && i.width( m.offsetWidth )) : d ? i.width( m.offsetWidth ) : n && i.width( n );
                Eb( a, i[0] );
                if (f) {
                    for (k = h = 0; k < e.length; k++) {
                        l = c[e[k]], d = g( j[k] ).outerWidth(), h += null === l.sWidthOrig ? d : parseInt( l.sWidth,
                            10 ) + d - g( j[k] ).width();
                    }
                    i.width( s( h ) );
                    b.style.width = s( h )
        ...
        function Fb( a, b )
        {
            for (var c, e = -1, d = -1, f = 0, h = a.aoData.length; f < h; f++) {
                c = v( a, f, b,
                    "display" ) + "", c = c.replace( Zb, "" ), c.length > e && (e = c.length, d = f);
            }
            return d
        }
        ...
        function T( a )
        {
            ...
            for (a = 0; a < n.length; a++) {
                ...
                for (c = f.length; b < c; b++) {
                    h = f[b], i = d[h].sType || "string", n[a]._idx === l && (n[a]._idx = g.inArray( n[a][1],
        ...
        function kb( a )
        {
            ...
            if ("ssp" != A( a ) && 0 !== n.length) {
                ...
                } ) : j.sort( function( a, b )
                {
                    ...
                    for (g = 0; g < j; g++) {
                        if (i = n[g], c = l[i.col], h = p[i.col], i = d[i.type + "-" + i.dir] || d["string-" + i.dir], c = i( c,
                                h ), 0 !== c) {
                            return c;
                        }
                    }
        ...
        function Ib( a )
        {
            for (var b, c, e = a.aoColumns, d = T( a ), a = a.oLanguage.oAria, f = 0, h = e.length; f < h; f++) {
                ...
                c.bSortable && (0 < d.length && d[0].col == f ? (j.setAttribute( "aria-sort",
                    "asc" == d[0].dir ? "ascending" : "descending" ), c = g[d[0].index + 1] || g[0]) : c = g[0], b += "asc" === c ? a.sSortAscending : a.sSortDescending);
        ...
        function Ta( a, b, c, e )
        {
            ...
            "number" === typeof d[0] &&
            (d = a.aaSorting = [d]);
            c && a.oFeatures.bSortMulti ? (c = g.inArray( b, C( d, "0" ) ), -1 !== c ? (b = h( d[c],
                !0 ), null === b ? d.splice( c, 1 ) : (d[c][1] = f[b], d[c]._idx = b)) : (d.push( [
                b,
                f[0],
                0
            ] ), d[d.length - 1]._idx = 0)) : d.length && d[0][0] == b ? (b = h( d[0] ), d.length = 1, d[0][1] = f[b], d[0]._idx = b) : (d.length = 0, d.push( [
                b,
                f[0]
            ] ), d[0]._idx = 0);
            M( a );
        ...
        function wa( a )
        {
            ...
            if (d.bSort && d.bSortClasses) {
                d = 0;
                for (f = b.length; d < f; d++) {
                    h = b[d].src, g( C( a.aoData, "anCells",
                        h ) ).removeClass( c + (2 > d ? d + 1 : 3) );
                }
                d = 0;
                for (f = e.length; d < f; d++) {
                    h = e[d].src, g( C( a.aoData, "anCells",
                        h ) ).addClass( c + (2 > d ? d + 1 : 3) )
                }
            }
            a.aLastSort = e
        }
        ...
        function Hb( a, b )
        {
            ...
            j; g++) {
                if (c = a.aoData[g], c._aSortData || (c._aSortData = []), !c._aSortData[b] || e) {
                    f = e ? d[g] : v( a,
                        g, b, "sort" ), c._aSortData[b] = h ? h( f ) : f
                }
            }
        }
        ...
        function Jb( a )
        {
            ...
            if (a.oFeatures.bStateSave) {
                ...
                if (d && d.time && (b = u( a, "aoStateLoadParams", "stateLoadParams", [a, d] ), -1 === g.inArray( !1,
                        b ) && (b = a.iStateDuration, !(0 < b && d.time < +new Date - 1E3 * b) && e.length === d.columns.length))) {
        ...
        function Kb( a, b, c )
        {
            var e, d;
            for (d in b) {
                b.hasOwnProperty( d ) && (e = b[d], g.isPlainObject( e ) ? (g.isPlainObject( a[d] ) || (a[d] = {}), g.extend( !0,
                    a[d], e )) : a[d] = c && "data" !== d && "aaData" !== d && g.isArray( e ) ? e.slice() : e);
            }
            return a
        }
        ...
        function Va( a, b )
        {
            ...
            b <= c ? c = U( 0, b ) : a <= e ? (c = U( 0,
                c - 2 ), c.push( "ellipsis" ), c.push( b - 1 )) : (a >= b - 1 - e ? c = U( b - (c - 2),
                b ) : (c = U( a - 1, a + 2 ), c.push( "ellipsis" ), c.push( b - 1 )), c.splice( 0, 0,
        ...
        var p, w, q, r, t, Xa = {}, Nb = /[\r\n]/g, Aa = /<.*?>/g, $b = /^[\w\+\-]/, ac = /[\w\+\-]$/, Xb = RegExp( "(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)",
            ...
            {
                return H( a ) ? !0 : !(H( a ) || "string" === typeof a) ? null : Ya( a.replace( Aa, "" ), b,
                    c ) ? !0 : null
            }, C = function(
                a,
                b, c
        ...
        p = function( a )
        {
            ...
            {
                var d = {}, d = 1 < e ? Kb( d, a,
                    !0 ) : a, h = 0, i, j = this.getAttribute( "id" ), n = !1, m = p.defaults;
                if ("table" != this.nodeName.toLowerCase()) {
                    R( null, 0,
                        "Non-table node initialisation (" + this.nodeName + ")", 2 );
                } else {
                    db( m );
                    eb( m.column );
                    G( m, m, !0 );
                    ...
                    j = k.oClasses;
                    d.bJQueryUI ? (g.extend( j, p.ext.oJUIClasses,
                        d.oClasses ), d.sDom === m.sDom && "lfrtip" === m.sDom && (k.sDom = '<"H"lfr>t<"F"ip>'), k.renderer) ?
                    g.isPlainObject( k.renderer ) && !k.renderer.header && (k.renderer.header = "jqueryui") : k.renderer = "jqueryui" : g.extend( j,
                        p.ext.classes, d.oClasses );
                    ...
                    if (d.aaData) {
                        ...
                        (k.bDeferLoading || "dom" == A( k )) && la( k,
                            g( k.nTBody ).children( "tr" ) );
                    }
        ...
        q.prototype = {
            ...
            }, filter: function( a )
            {
                var b = [];
                if (y.filter) {
                    b = y.filter.call( this, a,
                        this );
                } else {
                    for (var c = 0, e = this.length; c < e; c++) {
                        a.call( this, this[c], c,
                            this ) && b.push( this[c] );
                    }
                }
            ...
            }, iterator: function( a, b, c, e )
            {
                ...
                for (g = m.length; h < g; h++) {
                    ...
                    if ("table" === b) {
                        ...
                        if ("columns" === b || "rows" === b) {
                            f = c.call( r, m[h], this[h],
                                h ), f !== l && d.push( f );
                        } else {
                            if ("column" === b || "column-rows" === b || "row" === b || "cell" ===
                                b) {
                                k = this[h];
                                "column-rows" === b && (o = Ba( m[h], p.opts ));
                                j = 0;
                                for (n = k.length; j < n; j++) {
                                    f = k[j], f = "cell" === b ? c.call( r, m[h], f.row,
                                        f.column, h, j ) : c.call( r, m[h], f, h, j, o ), f !== l && d.push( f )
                                }
                            }
                        }
                    }
                }
                return d.length || e ? (a = new q( m, a ? d.concat.apply( [],
                    d ) : d ), b = a.selector, b.rows = p.rows, b.cols = p.cols, b.opts = p.opts, a) : this
        ...
        q.extend = function( a, b, c )
        {
            if (b && (b instanceof q || b.__dt_wrapper)) {
                ...
                e = 0;
                for (d = c.length; e < d; e++) {
                    f = c[e], b[f.name] = "function" === typeof f.val ? h( a, f.val,
                        f ) : g.isPlainObject( f.val ) ? {} : f.val, b[f.name].__dt_wrapper = !0, q.extend( a,
                        b[f.name],
                        f.propExt )
                }
            }
        ...
        q.registerPlural = t = function( a, b, c )
        {
            ...
            q.register( b, function()
            {
                ...
                return a === this ? this : a instanceof q ? a.length ? g.isArray( a[0] ) ? new q( a.context,
                    a[0] ) : a[0] : l : a
            } )
        };
        r( "tables()", function( a )
        ...
        var Za = function( a, b )
        {
            ...
            for (h = a.length; f < h; f++) {
                ...
                for (j =
                         d.length; i < j; i++) {
                    (e = b( "string" === typeof d[i] ? g.trim( d[i] ) : d[i] )) && e.length && c.push.apply( c,
                        e )
                }
            }
            return c
        ...
        }, Ba = function( a, b )
        {
            ...
            if ("current" == d) {
                ...
                if ("current" == e || "applied" == e) {
                    f = "none" == i ? c.slice() : "applied" == i ? h.slice() : g.map( c,
                        function( a )
                        {
                            return -1 === g.inArray( a, h ) ? a : null
                        } );
                } else {
                    if ("index" == e || "original" == e) {
                        c = 0;
                        for (e = a.aoData.length; c < e; c++) {
                            "none" == i ? f.push( c ) : (d = g.inArray( c,
                                h ), (-1 === d && "removed" == i || 0 <= d && "applied" == i) && f.push( c ))
                        }
                    }
                }
            }
            ...
            var b = $a( b ), c = this.iterator( "table",
                function( c )
                {
                    ...
                    return Za( a, function( a )
                    {
                        ...
                        return a.nodeName && g.inArray( a,
                            b ) !== -1 ? [a._DT_RowIndex] : g( b ).filter( a ).map( function()
                        {
        ...
        r( "rows.add()", function( a )
        {
            var b = this.iterator( "table", function( b )
            {
                ...
                f = 0;
                for (h = a.length; f < h; f++) {
                    c = a[f], c.nodeName && "TR" === c.nodeName.toUpperCase() ? g.push( la( b,
                        c )[0] ) :
                        g.push( I( b, c ) );
                }
                return g
                    ...
                    } ), f.on( "column-visibility.dt.DT_details", function( a, b )
                    {
                        if (d === b) {
                            for (var c, e = aa( b ), f = 0, g = h.length; f < g; f++) {
                                c = h[f], c._details && c._details.children( "td[colspan]" ).attr( "colspan",
                                    e )
                            }
                        }
        ...
        var cc = /^(.+):(name|visIdx|visible)$/, Vb = function(
            a,
            b, c, e, d
        )
        {
                ...
                if (a !== l && f.bVisible !== a) {
                    if (a) {
                        ...
                        for (j = h.length; i < j; i++) {
                            n = h[i].nTr, d = h[i].anCells, n && n.insertBefore( d[e],
                                d[m] || null )
                        }
                    } else {
        ...
        r( "cells()", function( a, b, c )
        {
            ...
            if (null === b || b === l) {
                return this.iterator( "table", function( b )
                {
                    var e = a, d = $a( c ), f = b.aoData, h = Ba( b, d ), d = Rb( ha( f, h,
                        "anCells" ) ), i = g( [].concat.apply( [], d ) ), j, m = b.aoColumns.length, n, p, r, q, s, t;
            ...
            var e = this.columns( b, c ), d = this.rows( a, c ), f, h, i, j, n, m = this.iterator( "table",
                function( a, b )
                {
                    f = [];
                    h = 0;
        ...
        r( "destroy()", function( a )
        {
            ...
            return this.iterator( "table", function( b )
            {
                var c = b.nTableWrapper.parentNode, e = b.oClasses, d = b.nTable, f = b.nTBody, h = b.nTHead, i = b.nTFoot, j = g( d ), f = g( f ), l = g( b.nTableWrapper ), m = g.map( b.aoData,
                    function( a )
                    {
                        return a.nTr
                    } ), o;
                ...
                g( "th, td",
                    h ).removeClass( e.sSortable + " " + e.sSortableAsc + " " + e.sSortableDesc + " " + e.sSortableNone );
                b.bJUI && (g( "th span." + e.sSortIcon + ", td span." + e.sSortIcon, h ).detach(), g( "th, td",
                    h ).each( function()
                {
        ...
        p.render = {
            number: function( a, b, c, e )
            {
                return {
                    ...
                    {
                        var f =
                            0 > d ? "-" : "", d = Math.abs( parseFloat( d ) ), g = parseInt( d,
                            10 ), d = c ? b + (d - g).toFixed( c ).substring( 2 ) : "";
