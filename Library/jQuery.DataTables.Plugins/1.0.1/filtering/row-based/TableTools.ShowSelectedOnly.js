...
(function( window, document, $, undefined )
{
    ...
    $.fn.dataTable.SelectedLengthMenu = function( oSettings )
    {
        ...
        nLength.innerHTML = '<span>' + sLengthMenu.replace( '_MENU_', sStdMenu ).replace( '_SELECTEDMENU_',
            sSelectedMenu ) + '</span>';
        ...
        $filterSelectedSelect.find( 'option[value="' + oSettings._sFilterSelected + '"]', nLength ).attr( 'selected',
            true );
