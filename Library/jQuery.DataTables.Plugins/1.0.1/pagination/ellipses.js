...
$.fn.dataTableExt.oPagination.ellipses = {
    ...
    'fnInit': function( oSettings, nPager, fnCallbackDraw )
    {
        ...
        oFirst.click( {'fnCallbackDraw': fnCallbackDraw, 'oSettings': oSettings, 'sPage': 'first'},
            that.fnClickHandler );
        oPrevious.click( {'fnCallbackDraw': fnCallbackDraw, 'oSettings': oSettings, 'sPage': 'previous'},
            that.fnClickHandler );
    ...
    'fnUpdate': function( oSettings, fnCallbackDraw )
    {
        ...
        for (i = oSettings._iFirstPage; i <= oSettings._iLastPage; i++) {
            ...
            if (oSettings._iCurrentPage === i) {
                ...
                oNumber.click( {'fnCallbackDraw': fnCallbackDraw, 'oSettings': oSettings, 'sPage': i - 1},
                    that.fnClickHandler );
            }
