...
(function( i, j, a )
{
    ...
    {
        var c = new a.fn.dataTable.Api( d ), f = c.settings()[0], e = a( "<div></div>" ).addClass( f.oClasses.sLength ), h = -1;
        ...
        {
            if (c.page.len() !== h) {
                var b = f.aLengthMenu, d = 2 === b.length && a.isArray( b[0] ) ? b[1] : b, g = 2 === b.length && a.isArray( b[0] ) ? b[0] : b, b = a.map( g,
                    function( b, a )
                    {
    ...
    a.fn.dataTable.ext.feature.push( {
        ...
        }, cFeature: "L", sFeature: "LengthLinks"
    } )
