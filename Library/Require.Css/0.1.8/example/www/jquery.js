        ...
        jQuery( function()
        {
            ...
            if (window.getComputedStyle) {
                ...
                support.reliableMarginRight =
                    ( parseInt( ( window.getComputedStyle( marginDiv, null ) || {marginRight: 0} ).marginRight,
                        10 ) || 0 ) === 0;
            }
                    ...
                    if (!seed && !Sizzle.isXML( context )) {
                        ...
                        if (context.nodeType === 9) {
                            ...
                            if (context.nodeType === 1 && context.nodeName.toLowerCase() !== "object") {
                                ...
                                try {
                                    if (!relativeHierarchySelector || hasParent) {
                                        return makeArray( context.querySelectorAll( "[id='" + nid + "'] " + query ),
                                            extra );
                                    }
    ...
    jQuery.extend( {
        ...
        clean: function( elems, context, fragment, scripts )
        {
            ...
            if (fragment) {
                ...
                for (i = 0; ret[i]; i++) {
                    script = ret[i];
                    if (scripts && jQuery.nodeName( script,
                            "script" ) && (!script.type || rscriptType.test( script.type ))) {
...
// DEPRECATED in 1.3, Use jQuery.css() instead
    ...
    if (jQuery.expr && jQuery.expr.filters) {
        jQuery.expr.filters.hidden = function( elem )
        {
            ...
            return ( width === 0 && height === 0 ) || (!jQuery.support.reliableHiddenOffsets && ((elem.style && elem.style.display) || jQuery.css( elem,
                    "display" )) === "none");
        };
                ...
                for (var i = 0, j = this.length; i < j; i++) {
                    ...
                    if (elem.style) {
                        ...
                        if ((display === "" && jQuery.css( elem,
                                "display" ) === "none") || !jQuery.contains( elem.ownerDocument.documentElement,
                                elem )) {
            ...
            function doAnimation()
            {
                ...
                for (p in prop) {
                    ...
                    if (rfxtypes.test( val )) {
                        ...
                        method = jQuery._data( this,
                            "toggle" + p ) || ( val === "toggle" ? hidden ? "show" : "hide" : 0 );
                        if (method) {
    ...
    jQuery.fn.extend( {
        ...
        offsetParent: function()
        {
            return this.map( function()
            {
                ...
                while (offsetParent && (!rroot.test( offsetParent.nodeName ) && jQuery.css( offsetParent,
                    "position" ) === "static")) {
