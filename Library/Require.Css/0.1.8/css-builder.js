define( ['require', './normalize'], function( req, normalize )
{
    ...
    function loadFile( path )
    {
        if (typeof process !== "undefined" && process.versions && !!process.versions.node && require.nodeRequire) {
            ...
            var file = new java.io.File( path ),
                ...
                input = new java.io.BufferedReader( new java.io.InputStreamReader( new java.io.FileInputStream( file ),
                    'utf-8' ) ),
                stringBuffer, line;
            try {
    ...
    function saveFile( path, data )
    {
        if (typeof process !== "undefined" && process.versions && !!process.versions.node && require.nodeRequire) {
            ...
            var output = new java.io.BufferedWriter( new java.io.OutputStreamWriter( new java.io.FileOutputStream( path ),
                'utf-8' ) );
    ...
    cssAPI.onLayerEnd = function( write, data )
    {
        ...
        if (config.separateCSS) {
            ...
            if (config.buildCSS != false && config.writeCSSModule != true) {
