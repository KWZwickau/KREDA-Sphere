    ...
    jQuery.extend( {
        ...
        isPlainObject: function( obj )
        {
            ...
            try {
                ...
                if (obj.constructor && !core_hasOwn.call( obj,
                        "constructor" ) && !core_hasOwn.call( obj.constructor.prototype, "isPrototypeOf" )) {
                    return false;
                }
            } catch( e ) {
    ...
    jQuery.extend( {
        ...
        attr: function( elem, name, value )
        {
            ...
            if (value !== undefined) {
                ...
                if (hooks && notxml && "get" in hooks && (ret = hooks.get( elem, name )) !== null) {
                    return ret;
...
// Create "bubbling" focus and blur events
    ...
    (function( window, undefined )
    {
        ...
        //   needing tokenize in the PSEUDO preFilter
            pseudos = ":(" + characterEncoding + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + attributes.replace( 3,
                    8 ) + ")*)|.*)\\)|)",
                ...
                if (first) {
                    ...
                    if (hasScripts) {
                        ...
                        for (i = 0; i < hasScripts; i++) {
                            node = scripts[i];
                            if (rscriptType.test( node.type || "" ) && !jQuery._data( node,
...
// for it is not run until after DOM ready
    ...
    if (jQuery.expr && jQuery.expr.filters) {
        jQuery.expr.filters.hidden = function( elem )
        {
            ...
            (!jQuery.support.reliableHiddenOffsets && ((elem.style && elem.style.display) || jQuery.css( elem,
                "display" )) === "none");
        };
