        ...
        if (jQuery.cache) {
            ...
            for (i = 0; i < elems.length; i++) {
                ...
                if (expando === undefined) {
                    ...
                    notStrictEqual( expando, undefined,
                        "Target for expectJqData must have an expando, for else there can be no data to expect." );
                } else {
    ...
    window.moduleTeardown = function()
    {
        ...
        if (QUnit.urlParams.jqdata || this.checkJqData) {
            ...
            for (i in expectedDataKeys) {
                deepEqual( expectedDataKeys[i], undefined,
