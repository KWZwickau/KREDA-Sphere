...
function testText( valueObj )
{
    ...
    equal( jQuery( "#foo" ).text( val )[0].innerHTML.replace( />/g, "&gt;" ),
    ...
    equal( jQuery( "#nonnodes" )[0].childNodes.length < 3 ? 8 : j[2].nodeType, 8,
        "Check node,textnode,comment with text()" );
...
function testAppend( valueObj )
{
    ...
    equal( jQuery( "#select3" ).append( valueObj( "<option value='appendTest'>Append Test</option>" ) ).find( "option:last-child" ).attr( "value" ),
    ...
    try {
        if (iframeDoc && iframeDoc.body) {
            equal( jQuery( iframeDoc.body ).append( valueObj( "<div id='success'>test</div>" ) )[0].lastChild.id,
                "success", message );
        } else {
    ...
    equal( jQuery( "#select1 optgroup" ).attr( "label" ), "optgroup",
    ...
    equal( jQuery( "<div />" ).append( "1", "", 3 ).text(), "13",
    ...
    equal( jQuery( "<div/>" ).append( valueObj( "option<area/>" ) )[0].childNodes.length, 2,
...
test( "html(String) with HTML5 (Bug #6485)", function()
{
    ...
    equal( jQuery( "#qunit-fixture" ).children().children().length, 1,
        "Make sure HTML5 article elements can hold children. innerHTML shortcut path" );
    equal( jQuery( "#qunit-fixture" ).children().children().children().length, 1,
...
test( "appendTo(String)", function()
{
    ...
    equal( jQuery( "<option value='appendTest'>Append Test</option>" ).appendTo( "#select3" ).parent().find( "option:last-child" ).attr( "value" ),
        "appendTest", "Appending html options to select element" );
...
test( "appendTo(jQuery)", function()
{
    ...
    ok( jQuery( document.createElement( "script" ) ).appendTo( "body" ).length,
        "Make sure a disconnected script can be appended." );
...
test( "prepend(String)", function()
{
    ...
    equal( jQuery( "#select3" ).prepend( "<option value='prependTest'>Prepend Test</option>" ).find( "option:first-child" ).attr( "value" ),
        "prependTest", "Prepending html options to select element" );
} );
...
test( "prependTo(String)", function()
{
    ...
    equal( jQuery( "<option value='prependTest'>Prepend Test</option>" ).prependTo( "#select3" ).parent().find( "option:first-child" ).attr( "value" ),
        "prependTest", "Prepending html options to select element" );
...
test( "before(Array<Element>)", function()
{
    ...
    jQuery( "#yahoo" ).before( manipulationBareObj( [
...
test( "before(Function) -- Returns Array<Element>", function()
{
    ...
    var expected;
    expected = "This is a normal link: Try them out:diveintomarkYahoo";
    jQuery( "#yahoo" ).before( manipulationFunctionReturningObj( [
        document.getElementById( "first" ),
        document.getElementById( "mark" )
    ] ) );
    equal( jQuery( "#en" ).text(), expected, "Insert array of elements before" );
...
test( ".before() and .after() disconnected node", function()
{
    ...
    equal( jQuery( "<input type='checkbox'/>" ).before( "<div/>" ).length, 1,
...
function testReplaceWith( val )
{
    ...
    deepEqual( jQuery( "#yahoo, #baz" ).get(), q( "yahoo", "baz" ),
    ...
    equal( jQuery( "#qunit-fixture" ).find( "div[id=replaceWith]" ).length, 1,
...
test( "jQuery.clone() (#8017)", function()
{
    ...
    equal( main.childNodes.length, clone.childNodes.length,
...
test( "clone()", function()
{
    ...
    equal( jQuery( "<input type='checkbox' />" ).clone()[0].nodeName.toLowerCase(), "input",
        "Clone a <input type='checkbox' />" );

    // Check cloning non-elements
    equal( jQuery( "#nonnodes" ).contents().clone().length, 3,
...
test( "clone(script type=non-javascript) (#11359)", function()
{
    ...
    ok( /^\s*<scr.pt\s+type=['"]?text\/filler['"]?\s*>consectetur adipiscing elit<\/scr.pt>\s*$/i.test( dest.last().html() ),
        "Cloning preserves nested script text" );
    dest.remove();
} );
...
test( "clone(multiple selected options) (Bug #8129)", function()
{
    ...
    equal( element.clone().find( "option:selected" ).length, element.find( "option:selected" ).length,
...
test( "html(undefined)", function()
{
    ...
    equal( jQuery( "#foo" ).html( "<i>test</i>" ).html( undefined ).html().toLowerCase(), "<i>test</i>",
...
test( "html(Function) with incoming value -- jQuery.contents()", function()
{
    ...
    equal( j.html().replace( / xmlns="[^"]+"/g, "" ).toLowerCase(), "<b>bold</b>",
...
test( "Ensure oldIE creates a new set on appendTo (#8894)", function()
{
    ...
    strictEqual( jQuery( "<div/>" ).clone().addClass( "test" ).appendTo( "<div/>" ).end().end().hasClass( "test" ),
        false, "Check jQuery.fn.appendTo after jQuery.clone" );
    strictEqual( jQuery( "<div/>" ).find( "p" ).end().addClass( "test" ).appendTo( "<div/>" ).end().end().hasClass( "test" ),
        false, "Check jQuery.fn.appendTo after jQuery.fn.find" );
    strictEqual( jQuery( "<div/>" ).text( "test" ).addClass( "test" ).appendTo( "<div/>" ).end().end().hasClass( "test" ),
        false, "Check jQuery.fn.appendTo after jQuery.fn.text" );
    strictEqual( jQuery( "<bdi/>" ).clone().addClass( "test" ).appendTo( "<div/>" ).end().end().hasClass( "test" ),
        false, "Check jQuery.fn.appendTo after clone html5 element" );
    strictEqual( jQuery( "<p/>" ).appendTo( "<div/>" ).end().length,
        jQuery( "<p>test</p>" ).appendTo( "<div/>" ).end().length,
...
test( "manipulate mixed jQuery and text (#12384, #12346)", function()
{
    ...
    var div = jQuery( "<div>a</div>" ).append( "&nbsp;", jQuery( "<span>b</span>" ), "&nbsp;",
            jQuery( "<span>c</span>" ) ),
...
testIframeWithCallback( "buildFragment works even if document[0] is iframe's window object in IE9/10 (#12266)",
    "manipulation/iframe-denied.html", function( test )
    {
        expect( 1 );
...
test( "insertAfter, insertBefore, etc do not work when destination is original element. Element is removed (#4087)",
    function()
    {
        ...
        ], function( index, name )
        {
            ...
            equal( jQuery( "#test4087-complex li:last-child div" ).length, name === "replaceAll" ? 1 : 2,
