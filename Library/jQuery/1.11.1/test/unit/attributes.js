...
test( "attr(String)", function()
{
    ...
    equal( jQuery( "#text1" ).attr( "value", "" ).attr( "value" ), "",
    ...
    equal( jQuery( "#form" ).attr( "action", "newformaction" ).attr( "action" ), "newformaction",
        "Check that action attribute was changed" );
    equal( jQuery( "#testForm" ).attr( "target" ), undefined,
        "Retrieving target does not equal the input with name=target" );
    equal( jQuery( "#testForm" ).attr( "target", "newTarget" ).attr( "target" ), "newTarget",
        "Set target successfully on a form" );
    equal( jQuery( "#testForm" ).removeAttr( "id" ).attr( "id" ), undefined,
    ...
    equal( jQuery( "#tAnchor5" ).prop( "href" ), jQuery( "#tAnchor6" ).prop( "href" ),
        "Check for absolute href prop on an anchor" );

    jQuery( "<script type='jquery/test' src='#5' id='scriptSrc'></script>" ).appendTo( "#qunit-fixture" );
    equal( jQuery( "#tAnchor5" ).prop( "href" ), jQuery( "#scriptSrc" ).prop( "src" ),
        "Check for absolute src prop on a script" );
    ...
    equal( jQuery( option ).prop( "selected" ), true,
    ...
    ok( !!~styleElem.attr( "style", "position:absolute;" ).attr( "style" ).indexOf( "absolute" ),
        "Check style setter" );
    ...
    equal( $button.attr( "value", "foobar" ).attr( "value" ), "foobar",
    ...
    equal( jQuery( "#table" ).attr( "test:attrib" ), undefined,
        "Retrieving a non-existent attribute on a table with a colon does not throw an error." );
    equal( jQuery( "#table" ).attr( "test:attrib", "foobar" ).attr( "test:attrib" ), "foobar",
    ...
    ok( jQuery( "<div/>" ).attr( "doesntexist" ) === undefined,
        "Make sure undefined is returned when no attribute is found." );
    ok( jQuery( "<div/>" ).attr( "title" ) === undefined,
        "Make sure undefined is returned when no attribute is found." );
    ...
    strictEqual( jQuery( "<select><option value='property'></option></select>" ).attr( "value" ), undefined,
...
test( "attr(String) on cloned elements, #9646", function()
{
    ...
    strictEqual( input.clone( true ).attr( "name", "test" )[0].name, "test",
        "Name attribute should be changed on cloned element" );

    div = jQuery( "<div id='tester' />" );
    div.attr( "id" );

    strictEqual( div.clone( true ).attr( "id", "test" )[0].id, "test",
        "Id attribute should be changed on cloned element" );

    input = jQuery( "<input value='tester' />" );
    input.attr( "value" );

    strictEqual( input.clone( true ).attr( "value", "test" )[0].value, "test",
        "Value attribute should be changed on cloned element" );

    strictEqual( input.clone( true ).attr( "value", 42 )[0].value, "42",
        "Value attribute should be changed on cloned element" );
} );
...
test( "attr(String) in XML Files", function()
{
    ...
    equal( jQuery( "location", xml ).attr( "checked" ), "different",
...
test( "attr(String, Object)", function()
{
    ...
    equal( $text.attr( "required", false ).attr( "required" ), undefined,
    ...
    equal( $text.attr( "aria-disabled", false ).attr( "aria-disabled" ), "false",
    ...
    jQuery.each( [commentNode, textNode, attributeNode], function( i, elem )
    {
        ...
        strictEqual( $elem.attr( "nonexisting" ), undefined,
    ...
    jQuery.each( [window, document, obj, "#firstp"], function( i, elem )
    {
        ...
        equal( $elem.attr( "nonexisting", "foo" ).attr( "nonexisting" ), "foo",
    ...
    equal( "checkbox", jQuery( check ).attr( "type" ),
    ...
    ok( thrown, "Exception thrown when trying to change type property" );
    equal( "checkbox", check.attr( "type" ),
        "Verify that you can change the type of an input element that isn't in the DOM" );
    ...
    equal( typeof jQuery( "#name" ).attr( "maxlength", undefined ), "object",
        ".attr('attribute', undefined) is chainable (#5571)" );
    equal( jQuery( "#name" ).attr( "maxlength", undefined ).attr( "maxlength" ), "5",
        ".attr('attribute', undefined) does not change value (#5571)" );
    equal( jQuery( "#name" ).attr( "nonexisting", undefined ).attr( "nonexisting" ), undefined,
...
test( "attr('tabindex')", function()
{
    ...
    // anchor without href
    equal( jQuery( "#linkWithNoHrefWithNoTabIndex" ).attr( "tabindex" ), undefined,
    ...
    equal( jQuery( "#linkWithNoHrefWithNegativeTabIndex" ).attr( "tabindex" ), "-1",
        "anchor without href, no tabindex set" );
} );
...
test( "removeAttr(String)", function()
{
    ...
    equal( jQuery( "#foo" ).attr( "style", "position:absolute;" ).removeAttr( "style" ).attr( "style" ), undefined,
        "Check removing style attribute" );
    equal( jQuery( "#form" ).attr( "style", "position:absolute;" ).removeAttr( "style" ).attr( "style" ), undefined,
        "Check removing style attribute on a form" );
    equal( jQuery( "<div style='position: absolute'></div>" ).appendTo( "#foo" ).removeAttr( "style" ).prop( "style" ).cssText,
        "", "Check removing style attribute (#9699 Webkit)" );
    equal( jQuery( "#fx-test-group" ).attr( "height", "3px" ).removeAttr( "height" ).get( 0 ).style.height, "1px",
...
test( "prop(String, Object)", function()
{
    ...
    equal( jQuery( "#text1" ).prop( "value", "Test2" ).prop( "defaultValue" ), "Test",
...
test( "prop(String, Object) on null/undefined", function()
{
    ...
    {
        strictEqual( jQuery( ele ).prop( "nonexisting" ), undefined,
    ...
    jQuery.each( [document, obj], function( i, ele )
    {
        ...
        equal( $ele.prop( "nonexisting" ), "foo",
...
test( "prop('tabindex')", function()
{
    ...
    equal( jQuery( "#linkWithNoHrefWithNegativeTabIndex" ).prop( "tabindex" ), -1,
        "anchor without href, no tabindex set" );
} );
...
test( "removeProp(String)", function()
{
    ...
    jQuery.each( [document, obj], function( i, ele )
    {
        ...
        strictEqual( ele["nonexisting"], undefined,
...
test( "val()", function()
{
    ...
    deepEqual( jQuery( "#select4" ).val(), ["2", "3"],
...
test( "removeClass(undefined) is a no-op", function()
{
    ...
    ok( $div.hasClass( "base" ) && $div.hasClass( "second" ),
