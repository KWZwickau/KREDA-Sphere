...
function dataTests( elem )
{
    ...
    strictEqual( jQuery.data( elem, "foo" ), "foo1",
    ...
    strictEqual( jQuery._data( elem ), internalDataObj,
    ...
    strictEqual( jQuery._data( elem, jQuery.expando ), undefined,
    ...
    jQuery.removeData( elem, "foo" );
    equal( jQuery._data( elem, "foo" ), "foo2",
...
test( "jQuery(Element).data(String, Object).data(String)", function()
{
    ...
    strictEqual( div.data( "test", undefined ).data( "test" ), "overwritten",
...
test( "jQuery.data supports interoperable hyphenated/camelCase get/set of properties with arbitrary non-null|NaN|undefined values",
    function()
    {
