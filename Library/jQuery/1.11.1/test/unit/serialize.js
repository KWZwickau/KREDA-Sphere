...
test( "jQuery.param()", function()
{
    ...
    equal( jQuery.param( params ), "someName%5B%5D=1&someName%5B%5D=2&someName%5B%5D=3&regularThing=blah",
        "with array" );
    ...
    equal( jQuery.param( params ), "foo%5B%5D=baz&foo%5B%5D=42&foo%5B%5D=All+your+base+are+belong+to+us",
        "more array" );

    params = {"foo": {"bar": "baz", "beep": 42, "quux": "All your base are belong to us"}};
    equal( jQuery.param( params ), "foo%5Bbar%5D=baz&foo%5Bbeep%5D=42&foo%5Bquux%5D=All+your+base+are+belong+to+us",
        "even more arrays" );

    params = {
        a: [1, 2],
        b: {c: 3, d: [4, 5], e: {x: [6], y: 7, z: [8, 9]}, f: true, g: false, h: undefined},
        i: [10, 11],
        j: true,
        k: false,
        l: [undefined, 0],
    ...
    equal( decodeURIComponent( jQuery.param( params ) ),
    ...
    equal( jQuery.param( params, true ),
        "a=1&a=2&b=%5Bobject+Object%5D&i=10&i=11&j=true&k=false&l=&l=0&m=cowboy+hat%3F",
        "huge structure, forced traditional" );

    equal( decodeURIComponent( jQuery.param( {
        "a": [1, 2, 3],
        "b[]": [4, 5, 6],
        "c[d]": [7, 8, 9],
        "e": {"f": [10], "g": [11, 12], "h": 13}
    ...
    // #7945
    equal( jQuery.param( {"jquery": "1.4.2"} ), "jquery=1.4.2",
        "Check that object with a jQuery property get serialized correctly" );
    ...
    equal( jQuery.param( params ), "a=1&a=2&b=%5Bobject+Object%5D&i=10&i=11&j=true&k=false&l=&l=0&m=cowboy+hat%3F",
        "huge structure" );
    ...
    equal( jQuery.param( params ), "a=0&a=1%2C2&a=3%2C4%2C5%2C6&a=%5Bobject+Object%5D&a=17",
        "nested arrays (not possible when jQuery.param.traditional == true)" );
    ...
    equal( decodeURIComponent( jQuery.param( params, false ) ),
        "a[]=1&a[]=2&b[c]=3&b[d][]=4&b[d][]=5&b[e][x][]=6&b[e][y]=7&b[e][z][]=8&b[e][z][]=9&b[f]=true&b[g]=false&b[h]=&i[]=10&i[]=11&j=true&k=false&l[]=&l[]=0&m=cowboy+hat?",
...
test( "jQuery.param() Constructed prop values", function()
{
    ...
    equal( jQuery.param( params, false ), jQuery.param( {"test": {"prop": "val"}} ),
