...
if (jQuery.css) {
    testIframeWithCallback( "body background is not lost if set prior to loading jQuery (#9239)",
        "support/bodyBackground.html", function( color, support )
        {
            expect( 2 );
            var okValue = {
                "#000000": true,
...
testIframeWithCallback( "A background on the testElement does not cause IE8 to crash (#9823)",
    "support/testElementCrash.html", function()
    {
        expect( 1 );
        ok( true, "IE8 does not crash" );
    } );

testIframeWithCallback( "box-sizing does not affect jQuery.support.shrinkWrapBlocks", "support/shrinkWrapBlocks.html",
    function( shrinkWrapBlocks )
    {
        expect( 1 );
        strictEqual( shrinkWrapBlocks, computedSupport.shrinkWrapBlocks,
...
(function()
{
    ...
    if (/chrome/i.test( userAgent )) {
        ...
        if (/opera.*version\/12\.1/i.test( userAgent )) {
            expected = {
                "ajax": true,
                "appendChecked": true,
                "boxSizing": true,
            ...
            if (/trident\/7\.0/i.test( userAgent )) {
                expected = {
                    "ajax": true,
                    "appendChecked": true,
                    "boxSizing": true,
                        ...
                        if (/msie 8\.0/i.test( userAgent )) {
                            ...
                            if (/msie 7\.0/i.test( userAgent )) {
                                ...
                                if (/msie 6\.0/i.test( userAgent )) {
                                    ...
                                    if (/7\.0(\.\d+|) safari/i.test( userAgent )) {
                                        expected = {
                                            "ajax": true,
                                            "appendChecked": true,
                                            "boxSizing": true,
                                        ...
                                        if (/6\.0(\.\d+|) safari/i.test( userAgent )) {
                                            expected = {
                                                "ajax": true,
                                                "appendChecked": true,
                                                "boxSizing": true,
                                            ...
                                            if (/5\.1(\.\d+|) safari/i.test( userAgent )) {
                                                expected = {
                                                    "ajax": true,
                                                    "appendChecked": true,
                                                    "boxSizing": true,
                                                ...
                                                if (/firefox/i.test( userAgent )) {
                                                    ...
                                                    if (/iphone os (?:6|7)_/i.test( userAgent )) {
                                                        expected = {
                                                            "ajax": true,
                                                            "appendChecked": true,
                                                            "boxSizing": true,
                                                        ...
                                                        if (/android 2\.3/i.test( userAgent )) {
                                                            ...
                                                            if (/android 4\.[0-3]/i.test( userAgent )) {
                                                                expected = {
                                                                    "ajax": true,
                                                                    "appendChecked": true,
                                                                    "boxSizing": true,
