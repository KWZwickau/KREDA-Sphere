...
(function()
{
    ...
    if (topdog) {
        ...
        var _addOnEvt = function(
            type,		// string
            refOrName,	// function or string
            scope
        )
        {		// object, defaults is window
            ...
            var enclosedFunc = function()
            {
                return funcRef.apply( scope, arguments );
            };
        ...
        {
            if (_groupTogglers[group]) {
                return _groupTogglers[group];
            }
            var rolledUp = true;
        ...
        doh._updateTestList = function( group, fixture, unwindingBacklog )
        {
            if (!loaded) {
                ...
                if (updateBacklog.length && !unwindingBacklog) {
                    var tr;
        ...
        doh._testFinished = function( group, fixture, success )
        {
            ...
            if (doh._inGroup == group) {
                ...
                if (gn && doh._curTestCount) {
                    ...
                    var groupfail = this._updateGlobalProgressBar( (doh._runedSuite + p - 1) / doh._groupCount, success,
                        group );
                ...
                doh._dojoPlotPerfResults = function( div, name, dataArray )
                {
                    ...
                    var chart = new dojox.charting.DataChart( div, {
                        ...
                        xaxis: {
                            ...
                            majorTickStep: Math.ceil( (dataArray.length - 1) / 10 ),
                            htmlLabels: false
                        },
