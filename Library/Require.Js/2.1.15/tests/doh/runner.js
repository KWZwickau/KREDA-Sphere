...
doh.registerDocTests = function( module )
{
    ...
    this.debug( "registerDocTests() requires dojo to be loaded into the environment. Skipping doctest set for module:",
        module );
};
(function()
{
...
doh.e = doh.assertError = function(
    /*Error object*/
    expectedError,
    /*Object*/
    scope,
