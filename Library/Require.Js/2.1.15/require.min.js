...
(function( ba )
{
    ...
    function ga( b )
    {
        ...
        {
            var f = a.map.id;
            a.error ? a.emit( "error", a.error ) : (b[f] = !0, v( a.depMaps, function(
                f,
                d
            )
            {
            ...
            }, completeLoad: function( a )
            {
                ...
                if (!b && !t( r, a ) && c && !c.inited) {
                    if (j.enforceDefine && (!g || !da( g ))) {
                        return e( a ) ? void 0 : w( C( "nodefine",
    ...
    if ("undefined" === typeof define) {
        ...
        {
            var c =
                b.xhtml ? document.createElementNS( "http://www.w3.org/1999/xhtml",
        ...
        g.load = function( b, c, d )
        {
            ...
            if (z) {
                return e = g.createNode( e, c, d ), e.setAttribute( "data-requirecontext",
                    ...
                    b.onScriptLoad )) :
                    (e.addEventListener( "load", b.onScriptLoad, !1 ), e.addEventListener( "error", b.onScriptError,
                        !1 )), e.src = d, J = e, D ? y.insertBefore( e, D ) : y.appendChild( e ), J = null, e;
            }
            if (ea) {
                try {
