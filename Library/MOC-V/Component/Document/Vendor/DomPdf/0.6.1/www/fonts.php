...
if (auth_ok()) {
    ...
    <form name="upload-font" method="post" action="controller.php?cmd=install-font" target="upload-font"
          enctype="multipart/form-data" onsubmit="return checkFileName(this)">
        ...
        <table class="setup">
            <tr>
                ...
                <td rowspan="6">
                    <iframe name="upload-font" id="upload-font" style="border: 0; width: 500px;"></iframe>
                </td>
            </tr>
            <tr>
