...
//								echo $styleAttributeKey.' = '.$styleAttributeValue.'<br />';
                            ...
                            switch ($styleAttributeKey) {
                                ...
                                case 'Size' :
                                    ...
                                    break;
                                case 'Color' :
                                    $this->_styles[$styleID]['font']['color']['rgb'] = substr( $styleAttributeValue,
                                        1 );
                                    break;
                                case 'Bold' :
...
//								echo $styleAttributeKey.' = '.$styleAttributeValue.'<br />';
                            switch ($styleAttributeKey) {
                                case 'Color' :
                                    $this->_styles[$styleID]['fill']['color']['rgb'] = substr( $styleAttributeValue,
                                        1 );
                                    break;
                            }
                        }
...
//
                            $objPHPExcel->getActiveSheet()->getCell( $columnID.$rowID )->setValueExplicit( ( ( $hasCalculatedValue ) ? $cellDataFormula : $cellValue ),
                                $type );
                            if ($hasCalculatedValue) {
