...
class MySqlPlatformTest extends AbstractPlatformTestCase
{
    ...
    public function testGenerateMixedCaseTableCreate()
    {
        ...
        $this->assertEquals( 'CREATE TABLE Foo (Bar INT NOT NULL) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB',
            array_shift( $sql ) );
    }
    ...
    public function testGeneratesSqlSnippets()
    {
        ...
        $this->assertEquals( 'CONCAT(column1, column2, column3)',
            $this->_platform->getConcatExpression( 'column1', 'column2', 'column3' ),
            'Concatenation function is not correct' );
    }
    ...
    public function testGetDateTimeTypeDeclarationSql()
    {
        ...
        $this->assertEquals( "DATETIME",
            $this->_platform->getDateTimeTypeDeclarationSQL( array( 'version' => false ) ) );
        $this->assertEquals( "TIMESTAMP",
            $this->_platform->getDateTimeTypeDeclarationSQL( array( 'version' => true ) ) );
