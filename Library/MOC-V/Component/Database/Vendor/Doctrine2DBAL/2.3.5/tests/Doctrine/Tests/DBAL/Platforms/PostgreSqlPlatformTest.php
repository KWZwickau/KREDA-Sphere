...
class PostgreSqlPlatformTest extends AbstractPlatformTestCase
{
    ...
    public function testGeneratesSqlSnippets()
    {
        ...
        $this->assertEquals( 'SUBSTR(column, 5)', $this->_platform->getSubstringExpression( 'column', 5 ),
            'Substring expression without length is not correct' );
        $this->assertEquals( 'SUBSTR(column, 0, 5)', $this->_platform->getSubstringExpression( 'column', 0, 5 ),
            'Substring expression with length is not correct' );
    }
    ...
    public function testGenerateTableWithAutoincrement()
    {
        ...
        $this->assertEquals( array( 'CREATE TABLE autoinc_table (id SERIAL NOT NULL)' ),
