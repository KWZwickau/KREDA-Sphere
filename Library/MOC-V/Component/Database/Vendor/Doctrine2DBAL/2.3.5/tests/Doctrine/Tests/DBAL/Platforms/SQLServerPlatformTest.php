...
class SQLServerPlatformTest extends AbstractPlatformTestCase
{
    ...
    public function testGeneratesSqlSnippets()
    {
        ...
        $this->assertEquals( 'RLIKE', $this->_platform->getRegexpExpression(),
            'Regular expression operator is not correct' );
    ...
    public function testModifyLimitQueryWithOffset()
    {
        ...
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY username DESC) AS doctrine_rownum FROM user) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 6 AND 15',
            $sql );
    }
