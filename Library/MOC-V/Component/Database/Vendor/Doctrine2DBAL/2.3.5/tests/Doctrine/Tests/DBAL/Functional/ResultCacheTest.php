...
class ResultCacheTest extends \Doctrine\Tests\DbalFunctionalTestCase
{
    ...
    private $expectedResult = array(
        array( 'test_int' => 100, 'test_string' => 'foo' ),
        array( 'test_int' => 200, 'test_string' => 'bar' ),
        array( 'test_int' => 300, 'test_string' => 'baz' )
    );
    private $sqlLogger;
    ...
    public function assertCacheNonCacheSelectSameFetchModeAreEqual( $expectedResult, $fetchMode )
    {
        ...
        $stmt = $this->_conn->executeQuery( "SELECT * FROM caching ORDER BY test_int ASC", array(), array(),
    ...
    public function testEmptyResultCache()
    {
        ...
        $stmt = $this->_conn->executeQuery( "SELECT * FROM caching WHERE test_int > 500", array(), array(),
