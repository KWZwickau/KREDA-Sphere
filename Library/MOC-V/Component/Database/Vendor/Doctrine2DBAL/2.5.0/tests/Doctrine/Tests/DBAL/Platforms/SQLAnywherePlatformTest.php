...
class SQLAnywherePlatformTest extends AbstractPlatformTestCase
{
    ...
    public function testGeneratesColumnTypesDeclarationSQL()
    {
        ...
        $this->assertEquals( 'UNSIGNED SMALLINT IDENTITY',
            $this->_platform->getSmallIntTypeDeclarationSQL( $fullColumnDef ) );
        ...
        $this->assertEquals( 'UNSIGNED INT IDENTITY',
            $this->_platform->getIntegerTypeDeclarationSQL( $fullColumnDef ) );
        ...
        $this->assertEquals( 'UNSIGNED BIGINT IDENTITY',
            $this->_platform->getBigIntTypeDeclarationSQL( $fullColumnDef ) );
    ...
    public function testGeneratesDDLSnippets()
    {
        ...
        $this->assertEquals( "START DATABASE 'foobar' AUTOSTOP OFF",
            $this->_platform->getStartDatabaseSQL( 'foobar' ) );
        $this->assertEquals( 'STOP DATABASE "foobar" UNCONDITIONALLY',
            $this->_platform->getStopDatabaseSQL( 'foobar' ) );
        ...
        $this->assertEquals( 'CREATE VIEW fooview AS '.$viewSql,
            $this->_platform->getCreateViewSQL( 'fooview', $viewSql ) );
    ...
    public function testGeneratesUniqueConstraintDeclarationSQL()
    {
        ...
        $this->assertEquals(
            'UNIQUE (a, b)',
            $this->_platform->getUniqueConstraintDeclarationSQL( null,
                new Index( null, array( 'a', 'b' ), true, false ) )
        );
    }
    ...
    public function testGeneratesSQLSnippets()
    {
        ...
        $this->assertEquals( "DATEADD(DAY, 4, '1987/05/02')",
            $this->_platform->getDateAddDaysExpression( "'1987/05/02'", 4 ) );
        $this->assertEquals( "DATEADD(HOUR, 12, '1987/05/02')",
            $this->_platform->getDateAddHourExpression( "'1987/05/02'", 12 ) );
        $this->assertEquals( "DATEADD(MINUTE, 2, '1987/05/02')",
            $this->_platform->getDateAddMinutesExpression( "'1987/05/02'", 2 ) );
        $this->assertEquals( "DATEADD(MONTH, 102, '1987/05/02')",
            $this->_platform->getDateAddMonthExpression( "'1987/05/02'", 102 ) );
        $this->assertEquals( "DATEADD(QUARTER, 5, '1987/05/02')",
            $this->_platform->getDateAddQuartersExpression( "'1987/05/02'", 5 ) );
        $this->assertEquals( "DATEADD(SECOND, 1, '1987/05/02')",
            $this->_platform->getDateAddSecondsExpression( "'1987/05/02'", 1 ) );
        $this->assertEquals( "DATEADD(WEEK, 3, '1987/05/02')",
            $this->_platform->getDateAddWeeksExpression( "'1987/05/02'", 3 ) );
        $this->assertEquals( "DATEADD(YEAR, 10, '1987/05/02')",
            $this->_platform->getDateAddYearsExpression( "'1987/05/02'", 10 ) );
        $this->assertEquals( "DATEDIFF(day, '1987/04/01', '1987/05/02')",
            $this->_platform->getDateDiffExpression( "'1987/05/02'", "'1987/04/01'" ) );
        $this->assertEquals( "DATEADD(DAY, -1 * 4, '1987/05/02')",
            $this->_platform->getDateSubDaysExpression( "'1987/05/02'", 4 ) );
        $this->assertEquals( "DATEADD(HOUR, -1 * 12, '1987/05/02')",
            $this->_platform->getDateSubHourExpression( "'1987/05/02'", 12 ) );
        $this->assertEquals( "DATEADD(MINUTE, -1 * 2, '1987/05/02')",
            $this->_platform->getDateSubMinutesExpression( "'1987/05/02'", 2 ) );
        $this->assertEquals( "DATEADD(MONTH, -1 * 102, '1987/05/02')",
            $this->_platform->getDateSubMonthExpression( "'1987/05/02'", 102 ) );
        $this->assertEquals( "DATEADD(QUARTER, -1 * 5, '1987/05/02')",
            $this->_platform->getDateSubQuartersExpression( "'1987/05/02'", 5 ) );
        $this->assertEquals( "DATEADD(SECOND, -1 * 1, '1987/05/02')",
            $this->_platform->getDateSubSecondsExpression( "'1987/05/02'", 1 ) );
        $this->assertEquals( "DATEADD(WEEK, -1 * 3, '1987/05/02')",
            $this->_platform->getDateSubWeeksExpression( "'1987/05/02'", 3 ) );
        $this->assertEquals( "DATEADD(YEAR, -1 * 10, '1987/05/02')",
            $this->_platform->getDateSubYearsExpression( "'1987/05/02'", 10 ) );
        ...
        $this->assertEquals( 'LOCATE(string_column, substring_column)',
            $this->_platform->getLocateExpression( 'string_column', 'substring_column' ) );
        $this->assertEquals( 'LOCATE(string_column, substring_column, 1)',
            $this->_platform->getLocateExpression( 'string_column', 'substring_column', 1 ) );
    ...
    public function testHasCorrectDateTimeTzFormatString()
    {
        ...
        $this->assertEquals( $this->_platform->getDateTimeFormatString(),
    ...
    public function testModifiesLimitQueryWithSubSelect()
    {
        ...
        $this->assertEquals(
            ...
            $this->_platform->modifyLimitQuery( 'SELECT * FROM (SELECT u.id as uid, u.name as uname FROM user) AS doctrine_tbl',
                10 )
        );
    }
    ...
    public function testReturnsBinaryTypeDeclarationSQL()
    {
        ...
        $this->assertSame( 'VARBINARY(32767)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'length' => 32767 ) ) );
        ...
        $this->assertSame( 'BINARY(1)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'fixed' => true, 'length' => 0 ) ) );
        $this->assertSame( 'BINARY(32767)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'fixed' => true, 'length' => 32767 ) ) );
        $this->assertSame( 'LONG BINARY',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'fixed' => true, 'length' => 32768 ) ) );
    }
    ...
    public function testAltersTableColumnCommentWithExplicitlyQuotedIdentifiers()
    {
        ...
        $table2 = new Table( '"foo"',
            array( new Column( '"bar"', Type::getType( 'integer' ), array( 'comment' => 'baz' ) ) ) );
