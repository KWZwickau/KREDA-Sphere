...
abstract class AbstractSQLServerPlatformTestCase extends AbstractPlatformTestCase
{
    ...
    public function testGeneratesSqlSnippets()
    {
        ...
        $this->assertEquals( '"', $this->_platform->getIdentifierQuoteCharacter(),
            'Identifier quote character is not correct' );
        $this->assertEquals( '(column1 + column2 + column3)',
            $this->_platform->getConcatExpression( 'column1', 'column2', 'column3' ),
            'Concatenation expression is not correct' );
    }
    ...
    public function testModifyLimitQuery()
    {
        ...
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY (SELECT 0)) AS doctrine_rownum FROM user) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 1 AND 10 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testModifyLimitQueryWithOffset()
    {
        ...
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY username DESC) AS doctrine_rownum FROM user) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 6 AND 15 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testModifyLimitQueryWithAscOrderBy()
    {
        ...
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY username ASC) AS doctrine_rownum FROM user) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 1 AND 10 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testModifyLimitQueryWithLowercaseOrderBy()
    {
        ...
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY username) AS doctrine_rownum FROM user) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 1 AND 10 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testModifyLimitQueryWithDescOrderBy()
    {
        ...
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY username DESC) AS doctrine_rownum FROM user) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 1 AND 10 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testModifyLimitQueryWithMultipleOrderBy()
    {
        ...
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY username DESC, usereamil ASC) AS doctrine_rownum FROM user) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 1 AND 10 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testModifyLimitQueryWithSubSelect()
    {
        ...
        $sql = $this->_platform->modifyLimitQuery( 'SELECT * FROM (SELECT u.id as uid, u.name as uname) dctrn_result',
            10 );
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY (SELECT 0)) AS doctrine_rownum FROM (SELECT u.id as uid, u.name as uname) dctrn_result) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 1 AND 10 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testModifyLimitQueryWithSubSelectAndOrder()
    {
        ...
        $sql = $this->_platform->modifyLimitQuery( 'SELECT * FROM (SELECT u.id as uid, u.name as uname ORDER BY u.name DESC) dctrn_result',
            10 );
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY u.name DESC) AS doctrine_rownum FROM (SELECT u.id as uid, u.name as uname) dctrn_result) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 1 AND 10 ORDER BY doctrine_rownum',
            $sql );

        $sql = $this->_platform->modifyLimitQuery( 'SELECT * FROM (SELECT u.id, u.name ORDER BY u.name DESC) dctrn_result',
            10 );
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY name DESC) AS doctrine_rownum FROM (SELECT u.id, u.name) dctrn_result) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 1 AND 10 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testModifyLimitQueryWithSubSelectAndMultipleOrder()
    {
        ...
        $sql = $this->_platform->modifyLimitQuery( 'SELECT * FROM (SELECT u.id as uid, u.name as uname ORDER BY u.name DESC, id ASC) dctrn_result',
            10, 5 );
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY u.name DESC, id ASC) AS doctrine_rownum FROM (SELECT u.id as uid, u.name as uname) dctrn_result) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 6 AND 15 ORDER BY doctrine_rownum',
            $sql );

        $sql = $this->_platform->modifyLimitQuery( 'SELECT * FROM (SELECT u.id uid, u.name uname ORDER BY u.name DESC, id ASC) dctrn_result',
            10, 5 );
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY u.name DESC, id ASC) AS doctrine_rownum FROM (SELECT u.id uid, u.name uname) dctrn_result) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 6 AND 15 ORDER BY doctrine_rownum',
            $sql );

        $sql = $this->_platform->modifyLimitQuery( 'SELECT * FROM (SELECT u.id, u.name ORDER BY u.name DESC, id ASC) dctrn_result',
            10, 5 );
        $this->assertEquals( 'SELECT * FROM (SELECT *, ROW_NUMBER() OVER (ORDER BY name DESC, id ASC) AS doctrine_rownum FROM (SELECT u.id, u.name) dctrn_result) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 6 AND 15 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testModifyLimitQueryWithFromColumnNames()
    {
        ...
        $this->assertEquals( 'SELECT * FROM (SELECT a.fromFoo, fromBar, ROW_NUMBER() OVER (ORDER BY (SELECT 0)) AS doctrine_rownum FROM foo) AS doctrine_tbl WHERE doctrine_rownum BETWEEN 1 AND 10 ORDER BY doctrine_rownum',
            $sql );
    }
    ...
    public function testCreateClusteredIndex()
    {
        ...
        $this->assertEquals( 'CREATE CLUSTERED INDEX idx ON tbl (id)',
            $this->_platform->getCreateIndexSQL( $idx, 'tbl' ) );
    }
    ...
    public function testCreateNonClusteredPrimaryKeyInTable()
    {
        ...
        $this->assertEquals( array( 'CREATE TABLE tbl (id INT NOT NULL, PRIMARY KEY NONCLUSTERED (id))' ),
    ...
    public function testCreateNonClusteredPrimaryKey()
    {
        ...
        $this->assertEquals( 'ALTER TABLE tbl ADD PRIMARY KEY NONCLUSTERED (id)',
            $this->_platform->getCreatePrimaryKeySQL( $idx, 'tbl' ) );
    }
    ...
    public function testAlterAddPrimaryKey()
    {
        ...
        $idx = new \Doctrine\DBAL\Schema\Index( 'idx', array( 'id' ), false, true );
        $this->assertEquals( 'ALTER TABLE tbl ADD PRIMARY KEY (id)',
            $this->_platform->getCreateIndexSQL( $idx, 'tbl' ) );
    }
    ...
    public function testGeneratesAlterTableSQLWithColumnComments()
    {
        ...
        $tableDiff->addedColumns['select'] = new Column( 'select', Type::getType( 'integer' ),
            array( 'comment' => '666' ) );
        $tableDiff->addedColumns['added_commented_type'] = new Column( 'added_commented_type',
            Type::getType( 'object' ) );
        ...
        $tableDiff->addedColumns['added_comment_with_string_literal_char'] = new Column( 'added_comment_with_string_literal_char',
            Type::getType( 'string' ), array( 'comment' => "''" ) );
    ...
    public function testReturnsBinaryTypeDeclarationSQL()
    {
        ...
        $this->assertSame( 'VARBINARY(8000)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'length' => 8000 ) ) );
        $this->assertSame( 'VARBINARY(MAX)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'length' => 8001 ) ) );

        $this->assertSame( 'BINARY(255)', $this->_platform->getBinaryTypeDeclarationSQL( array( 'fixed' => true ) ) );
        $this->assertSame( 'BINARY(255)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'fixed' => true, 'length' => 0 ) ) );
        $this->assertSame( 'BINARY(8000)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'fixed' => true, 'length' => 8000 ) ) );
        $this->assertSame( 'VARBINARY(MAX)',
            $this->_platform->getBinaryTypeDeclarationSQL( array( 'fixed' => true, 'length' => 8001 ) ) );
    }
    ...
    public function getGeneratesIdentifierNamesInDefaultConstraintDeclarationSQL()
    {
        ...
        return array(
            ...
            array(
                'mytable',
                array( 'name' => 'mycolumn', 'default' => 'foo' ),
    ...
    public function getGeneratesIdentifierNamesInCreateTableSQL()
    {
        ...
        return array(
            ...
            array(
                new Table( 'mytable',
                    array( new Column( 'mycolumn', Type::getType( 'string' ), array( 'default' => 'foo' ) ) ) ),
                array(
            ...
            array(
                new Table( 'table',
                    array( new Column( 'select', Type::getType( 'string' ), array( 'default' => 'foo' ) ) ) ),
                array(
