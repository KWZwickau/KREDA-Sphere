...
abstract class AbstractReaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAnnotations()
    {
        ...
        $this->assertInstanceOf( $annotName = 'Doctrine\Tests\Common\Annotations\DummyAnnotation',
        ...
        $this->assertEquals( 1, count( $propAnnots ) );
        $this->assertInstanceOf( $annotName = 'Doctrine\Tests\Common\Annotations\DummyJoinTable',
        ...
        $dummyAnnot = $reader->getMethodAnnotation( $class->getMethod( 'getField1' ),
        ...
        $dummyAnnot = $reader->getPropertyAnnotation( $class->getProperty( 'field1' ),
            'Doctrine\Tests\Common\Annotations\DummyAnnotation' );
    ...
    public function testAnnotationsWithVarType()
    {
        ...
        $this->assertInstanceOf( 'Doctrine\Tests\Common\Annotations\Fixtures\AnnotationTargetAll',
            $barAnnot[0]->annotation );
    }
    ...
    public function testAtInDescription()
    {
        ...
        $this->assertInstanceOf( 'Doctrine\Tests\Common\Annotations\Fixtures\AnnotationTargetPropertyMethod',
            $fooAnnot[0] );
        $this->assertInstanceOf( 'Doctrine\Tests\Common\Annotations\Fixtures\AnnotationTargetPropertyMethod',
            $barAnnot[0] );
    }
    ...
    public function testImportWithConcreteAnnotation()
    {
        ...
        $reader = $this->getReader();
        $property = new \ReflectionProperty( 'Doctrine\Tests\Common\Annotations\TestImportWithConcreteAnnotation',
            'field' );
    ...
    public function testIgnoresAnnotationsNotPrefixedWithWhitespace()
    {
        ...
        $annotation = $reader->getClassAnnotation( new \ReflectionClass( new TestIgnoresNonAnnotationsClass() ),
    ...
    public function testResetsPhpParserAfterUse()
    {
        ...
        $this->assertFalse( !self::$testResetsPhpParserAfterUseRun && class_exists( 'Doctrine_Tests_Common_Annotations_Fixtures_ClassNoNamespaceNoComment' ),
    ...
    public function testAnnotationEnumeratorException()
    {
        ...
        try {
            ...
            $this->assertEquals( '[Enum Error] Attribute "value" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationEnum declared on property Doctrine\Tests\Common\Annotations\Fixtures\ClassWithAnnotationEnum::$invalidProperty accept only [ONE, TWO, THREE], but got FOUR.',
                $exc->getMessage() );
        }
        ...
        try {
            ...
            $this->assertEquals( '[Enum Error] Attribute "value" of @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationEnum declared on method Doctrine\Tests\Common\Annotations\Fixtures\ClassWithAnnotationEnum::invalidMethod() accept only [ONE, TWO, THREE], but got 5.',
                $exc->getMessage() );
        }
    }
