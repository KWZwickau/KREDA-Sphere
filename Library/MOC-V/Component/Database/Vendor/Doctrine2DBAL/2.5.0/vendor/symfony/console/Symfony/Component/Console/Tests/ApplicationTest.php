...
class ApplicationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals( 'foo', $application->getName(),
    ...
    public function testHelp()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/application_gethelp.txt',
            $this->normalizeLineBreaks( $application->getHelp() ), '->setHelp() returns a help message' );
    }
    ...
    public function testHasGet()
    {
        ...
        $this->assertFalse( $application->has( 'afoobar' ),
    ...
    public function testFindNamespace()
    {
        ...
        $this->assertEquals( 'foo', $application->findNamespace( 'f' ),
    ...
    public function testFind()
    {
        ...
        $this->assertInstanceOf( 'FooCommand', $application->find( 'foo:bar' ),
    ...
    public function testFindAlternativeNamespace()
    {
        ...
        try {
            ...
            $this->assertEquals( 'There are no commands defined in the "Unknown-namespace" namespace.',
                $e->getMessage(),
    ...
    public function testSetCatchExceptions()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/application_renderexception1.txt',
            $tester->getDisplay( true ), '->setCatchExceptions() sets the catch exception flag' );
    ...
    public function testAsText()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/application_astext1.txt',
            $this->normalizeLineBreaks( $application->asText() ),
    ...
    public function testAsXml()
    {
        ...
        $this->assertXmlStringEqualsXmlFile( self::$fixturesPath.'/application_asxml2.txt',
            $application->asXml( 'foo' ), '->asXml() returns an XML representation of the application' );
    }
    ...
    public function testRenderException()
    {
        ...
        $tester->run( array( 'command' => 'foo' ), array( 'decorated' => false ) );
        $this->assertStringEqualsFile( self::$fixturesPath.'/application_renderexception1.txt',
            $tester->getDisplay( true ), '->renderException() renders a pretty exception' );

        $tester->run( array( 'command' => 'foo' ),
            array( 'decorated' => false, 'verbosity' => Output::VERBOSITY_VERBOSE ) );
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/application_renderexception2.txt',
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/application_renderexception3.txt',
            $tester->getDisplay( true ), '->renderException() renders a pretty exceptions with previous exceptions' );

        $tester->run( array( 'command' => 'foo3:bar' ), array( 'decorated' => true ) );
        $this->assertStringEqualsFile( self::$fixturesPath.'/application_renderexception3decorated.txt',
            $tester->getDisplay( true ), '->renderException() renders a pretty exceptions with previous exceptions' );
        ...
        $tester->run( array( 'command' => 'foo' ), array( 'decorated' => false ) );
        $this->assertStringEqualsFile( self::$fixturesPath.'/application_renderexception4.txt',
    ...
    public function testRenderExceptionWithDoubleWidthCharacters()
    {
        ...
        $this->assertStringEqualsFile( self::$fixturesPath.'/application_renderexception_doublewidth1.txt',
            $tester->getDisplay( true ), '->renderException() renderes a pretty exceptions with previous exceptions' );
