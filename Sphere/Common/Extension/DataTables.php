 ...
 */
class DataTables extends AbstractExtension
{
     ...
     */
    function __construct( EntityRepository $EntityRepository, $Filter = array() )
    {
        ...
        $this->Request = self::extensionRequest()->getParameterArray();
