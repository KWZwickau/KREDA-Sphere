...
class UserAgent extends \Faker\Provider\Base
{
    ...
    public static function chrome()
    {
        ...
        $platforms = array(
            '('.static::linuxPlatformToken().") AppleWebKit/$saf (KHTML, like Gecko) Chrome/".mt_rand( 13,
                15 ).'.0.'.mt_rand( 800, 899 ).".0 Safari/$saf",
            '('.static::windowsPlatformToken().") AppleWebKit/$saf (KHTML, like Gecko) Chrome/".mt_rand( 13,
                15 ).'.0.'.mt_rand( 800, 899 ).".0 Safari/$saf",
            '('.static::macPlatformToken().") AppleWebKit/$saf (KHTML, like Gecko) Chrome/".mt_rand( 13,
                15 ).'.0.'.mt_rand( 800, 899 ).".0 Safari/$saf"
        );
    ...
    public static function macPlatformToken()
    {
        ...
        return 'Macintosh; '.static::randomElement( static::$macProcessor ).' Mac OS X 10_'.mt_rand( 5,
            8 ).'_'.mt_rand( 0, 9 );
    }
    ...
    public static function firefox()
    {
        ...
        $platforms = array(
            '('.static::windowsPlatformToken().'; '.static::randomElement( static::$lang ).'; rv:1.9.'.mt_rand( 0,
                2 ).'.20) '.static::randomElement( $ver ),
    ...
    public static function safari()
    {
        ...
        $platforms = array(
            ...
            '('.static::macPlatformToken().' rv:'.mt_rand( 2,
                6 ).'.0; '.static::randomElement( static::$lang ).") AppleWebKit/$saf (KHTML, like Gecko) Version/$ver Safari/$saf",
            '(iPod; U; CPU iPhone OS '.mt_rand( 3, 4 ).'_'.mt_rand( 0,
                3 ).' like Mac OS X; '.static::randomElement( static::$lang ).") AppleWebKit/$saf (KHTML, like Gecko) Version/".mt_rand( 3,
                4 ).".0.5 Mobile/8B".mt_rand( 111, 119 )." Safari/6$saf",
        );
    ...
    public static function opera()
    {
        ...
        $platforms = array(
            '('.static::linuxPlatformToken().'; '.static::randomElement( static::$lang ).') Presto/2.9.'.mt_rand( 160,
                190 ).' Version/'.mt_rand( 10, 12 ).'.00',
            '('.static::windowsPlatformToken().'; '.static::randomElement( static::$lang ).') Presto/2.9.'.mt_rand( 160,
                190 ).' Version/'.mt_rand( 10, 12 ).'.00'
        );
    ...
    public static function internetExplorer()
    {
        ...
        return 'Mozilla/5.0 (compatible; MSIE '.mt_rand( 5,
            9 ).'.0; '.static::windowsPlatformToken().'; Trident/'.mt_rand( 3, 5 ).'.'.mt_rand( 0, 1 ).')';
