...
class PullRequest extends AbstractApi
{
    ...
    public function update( $username, $repository, $id, array $params )
    {
        ...
        return $this->patch( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/pulls/'.rawurlencode( $id ),
            $params );
    }
    ...
    public function merge( $username, $repository, $id, $message = null )
    {
        ...
        return $this->put( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/pulls/'.rawurlencode( $id ).'/merge',
            array(
