...
class Assets extends AbstractApi
{
    ...
    public function create( $username, $repository, $id, $name, $contentType, $content )
    {
        ...
        $response = $this->postRaw( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/releases/'.rawurlencode( $id ).'/assets?name='.$name,
            $content, array( 'Content-Type' => $contentType ) );
    ...
    public function edit( $username, $repository, $id, array $params )
    {
        ...
        return $this->patch( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/releases/assets/'.rawurlencode( $id ),
            $params );
    }
