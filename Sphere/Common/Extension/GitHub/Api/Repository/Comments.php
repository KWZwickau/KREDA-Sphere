...
class Comments extends AbstractApi
{
    ...
    public function create( $username, $repository, $sha, array $params )
    {
        ...
        return $this->post( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/commits/'.rawurlencode( $sha ).'/comments',
            $params );
    }
    ...
    public function update( $username, $repository, $comment, array $params )
    {
        ...
        return $this->patch( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/comments/'.rawurlencode( $comment ),
            $params );
    }
