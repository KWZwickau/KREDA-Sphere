...
class Issue extends AbstractApi
{
    ...
    public function all( $username, $repository, array $params = array() )
    {
        ...
        return $this->get( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/issues',
    ...
    public function org( $organization, $state, array $params = array() )
    {
        ...
        return $this->get( 'orgs/'.rawurlencode( $organization ).'/issues',
            array_merge( array( 'page' => 1, 'state' => $state ), $params ) );
    }
    ...
    public function update( $username, $repository, $id, array $params )
    {
        ...
        return $this->patch( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/issues/'.rawurlencode( $id ),
            $params );
    }
