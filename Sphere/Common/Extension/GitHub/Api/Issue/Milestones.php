...
class Milestones extends AbstractApi
{
    ...
    public function all( $username, $repository, array $params = array() )
    {
        ...
        return $this->get( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/milestones',
            array_merge( array( 'page' => 1, 'state' => 'open', 'sort' => 'due_date', 'direction' => 'desc' ),
                $params ) );
    }
    ...
    public function update( $username, $repository, $milestone, array $params )
    {
        ...
        return $this->patch( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/milestones/'.rawurlencode( $milestone ),
            $params );
    }
