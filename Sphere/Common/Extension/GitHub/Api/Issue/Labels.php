...
class Labels extends AbstractApi
{
    ...
    public function add( $username, $repository, $issue, $labels )
    {
        ...
        return $this->post( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/issues/'.rawurlencode( $issue ).'/labels',
            $labels );
    }
    ...
    public function replace( $username, $repository, $issue, array $params )
    {
        ...
        return $this->put( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/issues/'.rawurlencode( $issue ).'/labels',
            $params );
    }
