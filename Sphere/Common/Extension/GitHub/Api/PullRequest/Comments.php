...
class Comments extends AbstractApi
{
    ...
    public function create( $username, $repository, $pullRequest, array $params )
    {
        ...
        return $this->post( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/pulls/'.rawurlencode( $pullRequest ).'/comments',
            $params );
    }
    ...
    public function update( $username, $repository, $comment, array $params )
    {
        ...
        return $this->patch( 'repos/'.rawurlencode( $username ).'/'.rawurlencode( $repository ).'/pulls/comments/'.rawurlencode( $comment ),
            $params );
    }
