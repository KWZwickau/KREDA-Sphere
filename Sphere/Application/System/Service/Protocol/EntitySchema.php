...
abstract class EntitySchema extends AbstractService
{
    ...
    private function setTableProtocol( Schema &$Schema )
    {
        ...
        if (!$this->getDatabaseHandler()->hasIndex( $Table, array( 'ProtocolDatabase' ) )) {
        ...
        if (!$this->getDatabaseHandler()->hasIndex( $Table, array( 'ProtocolTimestamp' ) )) {
        ...
        if (!$this->getDatabaseHandler()->hasIndex( $Table, array( 'AccountUsername' ) )) {
        ...
        if (!$this->getDatabaseHandler()->hasIndex( $Table, array( 'PersonFirstName' ) )) {
        ...
        if (!$this->getDatabaseHandler()->hasIndex( $Table, array( 'PersonLastName' ) )) {
        ...
        if (!$this->getDatabaseHandler()->hasIndex( $Table, array( 'ConsumerName' ) )) {
        ...
        if (!$this->getDatabaseHandler()->hasIndex( $Table, array( 'ConsumerSuffix' ) )) {
