...
class Banking extends EntityAction
{
    ...
    public function executeRemoveDebtorCommodity(
        ...
        if ($this->actionRemoveDebtorCommodity( $tblDebtorCommodity )) {
            ...
            .new Redirect( '/Sphere/Billing/Banking/Select/Commodity', 0,
            ...
            .new Redirect( '/Sphere/Billing/Banking/Select/Commodity', 2,
                array( 'Id' => $tblDebtorCommodity->getTblDebtor()->getId() ) );
        }
    }
    ...
    public function executeAddDebtor(
        ...
        if (isset( $Debtor['DebtorNumber'] ) && Billing::serviceBanking()->entityDebtorByDebtorNumber( $Debtor['DebtorNumber'] )) {
            $View->setError( 'Debtor[DebtorNumber]',
        ...
        if (!$Error) {
            ...
            $this->actionAddDebtor( $Debtor['DebtorNumber'], $Debtor['LeadTimeFirst'], $Debtor['LeadTimeFollow'],
